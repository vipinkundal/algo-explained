...
export const algorithmPage = {
  ...
  "meaning": "Kosaraju’s Algorithm is a Graphs technique taught with a scc two pass dry run.",
  "problem": "It helps you recognize and solve the Kosaraju’s Algorithm pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Kosaraju’s Algorithm: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Kosaraju’s Algorithm when a problem statement matches the Graphs pattern and the planned visualization is scc two pass.",
  "memoryTrick": "Kosaraju’s Algorithm: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact scc two pass walkthrough for Kosaraju’s Algorithm.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the scc two pass idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Kosaraju’s Algorithm receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core scc two pass transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Kosaraju’s Algorithm?",
    "options": [
      {
        "key": "A",
