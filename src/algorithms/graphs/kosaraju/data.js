...
export const algorithmPage = {
  ...
  "concept": "Kosaraju’s Algorithm finds strongly connected components with one DFS order pass and one reversed-graph pass.",
  "logicSummary": "kosaraju maintains graph-specific state and updates it through the algorithm's own vertex or edge transition.",
  ...
  "visualizerCaption": "A scc two pass walkthrough showing Kosaraju’s Algorithm's input, state, transition, and answer.",
  "logicSteps": [
    {
  ...
  "variables": [
    ...
    },
    {
      ...
      "purpose": "The graph-owned state that changes as vertices or edges are processed. This page visualizes it as scc two pass."
    },
    {
      "name": "graph result",
      "purpose": "The value produced by kosaraju after the maintained state reaches the stop rule."
    },
    {
  ...
  "dryRun": [
    {
      "label": "Input",
      "title": "Read inputs",
      "note": "Kosaraju’s Algorithm starts by reading the exact input shape it owns.",
      "activeLine": 1
    },
    {
      "label": "State",
