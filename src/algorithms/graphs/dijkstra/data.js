...
export const algorithmPage = {
  ...
  "meaning": "Dijkstra’s Algorithm is a Graphs technique taught with a weighted graph dry run.",
  "problem": "It helps you recognize and solve the Dijkstra’s Algorithm pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Dijkstra’s Algorithm: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Dijkstra’s Algorithm when a problem statement matches the Graphs pattern and the planned visualization is weighted graph.",
  "memoryTrick": "Dijkstra’s Algorithm: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact weighted graph walkthrough for Dijkstra’s Algorithm.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the weighted graph idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Dijkstra’s Algorithm receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core weighted graph transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Dijkstra’s Algorithm?",
    "options": [
      {
        "key": "A",
