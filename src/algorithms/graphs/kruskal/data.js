...
export const algorithmPage = {
  ...
  "meaning": "Kruskal’s Algorithm is a Graphs technique taught with a mst edges dry run.",
  "problem": "It helps you recognize and solve the Kruskal’s Algorithm pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Kruskal’s Algorithm: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Kruskal’s Algorithm when a problem statement matches the Graphs pattern and the planned visualization is mst edges.",
  "memoryTrick": "Kruskal’s Algorithm: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact mst edges walkthrough for Kruskal’s Algorithm.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the mst edges idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Kruskal’s Algorithm receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core mst edges transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Kruskal’s Algorithm?",
    "options": [
      {
        "key": "A",
