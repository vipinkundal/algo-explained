...
export const algorithmPage = {
  ...
  "meaning": "Breadth-First Search is a Graphs technique taught with a graph queue dry run.",
  "problem": "It helps you recognize and solve the Breadth-First Search pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Breadth-First Search: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Breadth-First Search when a problem statement matches the Graphs pattern and the planned visualization is graph queue.",
  "memoryTrick": "Breadth-First Search: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact graph queue walkthrough for Breadth-First Search.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the graph queue idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Breadth-First Search receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core graph queue transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Breadth-First Search?",
    "options": [
      {
        "key": "A",
