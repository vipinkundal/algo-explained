...
export const algorithmPage = {
  ...
  "meaning": "Tarjan’s Algorithm is a Graphs technique taught with a low link dry run.",
  "problem": "It helps you recognize and solve the Tarjan’s Algorithm pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Tarjan’s Algorithm: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Tarjan’s Algorithm when a problem statement matches the Graphs pattern and the planned visualization is low link.",
  "memoryTrick": "Tarjan’s Algorithm: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact low link walkthrough for Tarjan’s Algorithm.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the low link idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Tarjan’s Algorithm receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core low link transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Tarjan’s Algorithm?",
    "options": [
      {
        "key": "A",
