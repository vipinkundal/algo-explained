...
export const algorithmPage = {
  ...
  "meaning": "Prim’s Algorithm is a Graphs technique taught with a mst growth dry run.",
  "problem": "It helps you recognize and solve the Prim’s Algorithm pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Prim’s Algorithm: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Prim’s Algorithm when a problem statement matches the Graphs pattern and the planned visualization is mst growth.",
  "memoryTrick": "Prim’s Algorithm: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact mst growth walkthrough for Prim’s Algorithm.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the mst growth idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Prim’s Algorithm receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core mst growth transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Prim’s Algorithm?",
    "options": [
      {
        "key": "A",
