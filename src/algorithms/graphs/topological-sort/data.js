...
export const algorithmPage = {
  ...
  "meaning": "Topological Sort is a Graphs technique taught with a dag order dry run.",
  "problem": "It helps you recognize and solve the Topological Sort pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Topological Sort: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Topological Sort when a problem statement matches the Graphs pattern and the planned visualization is dag order.",
  "memoryTrick": "Topological Sort: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact dag order walkthrough for Topological Sort.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the dag order idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Topological Sort receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core dag order transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Topological Sort?",
    "options": [
      {
        "key": "A",
