...
export const algorithmPage = {
  ...
  "meaning": "Cycle Detection in Undirected Graph is a Graphs technique taught with a graph visited dry run.",
  "problem": "It helps you recognize and solve the Cycle Detection in Undirected Graph pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Cycle Detection in Undirected Graph: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Cycle Detection in Undirected Graph when a problem statement matches the Graphs pattern and the planned visualization is graph visited.",
  "memoryTrick": "Cycle Detection in Undirected Graph: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact graph visited walkthrough for Cycle Detection in Undirected Graph.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the graph visited idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Cycle Detection in Undirected Graph receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core graph visited transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Cycle Detection in Undirected Graph?",
    "options": [
      {
        "key": "A",
