...
export const algorithmPage = {
  ...
  "concept": "Depth-First Search follows one branch completely before backtracking.",
  "logicSummary": "dfs maintains graph-specific state and updates it through the algorithm's own vertex or edge transition.",
  ...
  "visualizerCaption": "A graph stack walkthrough showing Depth-First Search's input, state, transition, and answer.",
  "logicSteps": [
    {
  ...
  "variables": [
    ...
    },
    {
      ...
      "purpose": "The graph-owned state that changes as vertices or edges are processed. This page visualizes it as graph stack."
    },
    {
      "name": "graph result",
      "purpose": "The value produced by dfs after the maintained state reaches the stop rule."
    },
    {
  ...
  "dryRun": [
    {
      "label": "Input",
      "title": "Read inputs",
      "note": "Depth-First Search starts by reading the exact input shape it owns.",
      "activeLine": 1
    },
    {
      "label": "State",
