...
export const algorithmPage = {
  ...
  "concept": "Sort integers digit by digit from least significant to most significant.",
  "logicSummary": "Radix Sort keeps a clear sorted/unsorted invariant and makes one transition that places values closer to final order.",
  ...
  "memoryTrick": "Radix Sort: protect the invariant after every comparison or move.",
  "visualizerCaption": "A digit buckets walkthrough showing Radix Sort's input, state, transition, and answer.",
  "logicSteps": [
    {
      "title": "Copy input",
  ...
  "variables": [
    ...
    },
    {
      ...
      "purpose": "The in-progress array plus pass, partition, bucket, or merge boundaries. This page visualizes it as digit buckets."
    },
    {
      "name": "sorted result",
      "purpose": "The value produced by radixSort after the maintained state reaches the stop rule."
    },
    {
  ...
  "dryRun": [
    {
      "label": "Input",
      "title": "Read inputs",
      "note": "Radix Sort starts by reading the exact input shape it owns.",
      "activeLine": 1
    },
    {
      "label": "State",
