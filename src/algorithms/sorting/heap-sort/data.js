...
export const algorithmPage = {
  ...
  "meaning": "Heap Sort is a Sorting technique taught with a heap tree dry run.",
  "problem": "It helps you recognize and solve the Heap Sort pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Heap Sort: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Heap Sort when a problem statement matches the Sorting pattern and the planned visualization is heap tree.",
  "memoryTrick": "Heap Sort: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact heap tree walkthrough for Heap Sort.",
  "logicSteps": [
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Heap Sort receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Heap Sort?",
    "options": [
      {
        "key": "A",
