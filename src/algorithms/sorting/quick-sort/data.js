...
export const algorithmPage = {
  ...
  "meaning": "Quick Sort is a Sorting technique taught with a partition dry run.",
  "problem": "It helps you recognize and solve the Quick Sort pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Quick Sort: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Quick Sort when a problem statement matches the Sorting pattern and the planned visualization is partition.",
  "memoryTrick": "Quick Sort: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact partition walkthrough for Quick Sort.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the partition idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Quick Sort receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core partition transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Quick Sort?",
    "options": [
      {
        "key": "A",
