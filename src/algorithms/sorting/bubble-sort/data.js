...
export const algorithmPage = {
  ...
  "meaning": "Bubble Sort is a Sorting technique taught with a bar swap dry run.",
  "problem": "It helps you recognize and solve the Bubble Sort pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Bubble Sort: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Bubble Sort when a problem statement matches the Sorting pattern and the planned visualization is bar swap.",
  "memoryTrick": "Bubble Sort: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact bar swap walkthrough for Bubble Sort.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the bar swap idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Bubble Sort receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core bar swap transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Bubble Sort?",
    "options": [
      {
        "key": "A",
