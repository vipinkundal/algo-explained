...
export const algorithmPage = {
  ...
  "meaning": "Merge Sort is a Sorting technique taught with a divide merge dry run.",
  "problem": "It helps you recognize and solve the Merge Sort pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Merge Sort: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Merge Sort when a problem statement matches the Sorting pattern and the planned visualization is divide merge.",
  "memoryTrick": "Merge Sort: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact divide merge walkthrough for Merge Sort.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the divide merge idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Merge Sort receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core divide merge transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Merge Sort?",
    "options": [
      {
        "key": "A",
