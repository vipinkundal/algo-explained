...
export const algorithmPage = {
  ...
  "concept": "Distribute values into buckets, sort each bucket, and concatenate the buckets.",
  "logicSummary": "Bucket Sort keeps a clear sorted/unsorted invariant and makes one transition that places values closer to final order.",
  ...
  "memoryTrick": "Bucket Sort: protect the invariant after every comparison or move.",
  "visualizerCaption": "A bucket groups walkthrough showing Bucket Sort's input, state, transition, and answer.",
  "logicSteps": [
    {
      "title": "Copy input",
  ...
  "dryRun": [
    {
      "label": "Input",
      "title": "Read inputs",
      "note": "Bucket Sort starts by reading the exact input shape it owns.",
      "activeLine": 1
    },
    {
      "label": "State",
