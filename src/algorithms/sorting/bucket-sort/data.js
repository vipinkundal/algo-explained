...
export const algorithmPage = {
  ...
  "meaning": "Bucket Sort is a Sorting technique taught with a bucket groups dry run.",
  "problem": "It helps you recognize and solve the Bucket Sort pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Bucket Sort: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Bucket Sort when a problem statement matches the Sorting pattern and the planned visualization is bucket groups.",
  "memoryTrick": "Bucket Sort: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact bucket groups walkthrough for Bucket Sort.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the bucket groups idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Bucket Sort receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core bucket groups transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Bucket Sort?",
    "options": [
      {
        "key": "A",
