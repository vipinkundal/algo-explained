...
export const algorithmPage = {
  ...
  "meaning": "Insertion Sort is a Sorting technique taught with a card insertion dry run.",
  "problem": "It helps you recognize and solve the Insertion Sort pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Insertion Sort: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Insertion Sort when a problem statement matches the Sorting pattern and the planned visualization is card insertion.",
  "memoryTrick": "Insertion Sort: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact card insertion walkthrough for Insertion Sort.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the card insertion idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Insertion Sort receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core card insertion transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Insertion Sort?",
    "options": [
      {
        "key": "A",
