...
export const algorithmPage = {
  ...
  "meaning": "Dutch National Flag is a Array Patterns technique taught with a three partition dry run.",
  "problem": "It helps you recognize and solve the Dutch National Flag pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Dutch National Flag: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Dutch National Flag when a problem statement matches the Array Patterns pattern and the planned visualization is three partition.",
  "memoryTrick": "Dutch National Flag: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact three partition walkthrough for Dutch National Flag.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the three partition idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Dutch National Flag receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core three partition transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Dutch National Flag?",
    "options": [
      {
        "key": "A",
