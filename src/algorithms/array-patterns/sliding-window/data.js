...
export const algorithmPage = {
  ...
  "meaning": "Sliding Window is a Array Patterns technique taught with a moving window dry run.",
  "problem": "It helps you recognize and solve the Sliding Window pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Sliding Window: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Sliding Window when a problem statement matches the Array Patterns pattern and the planned visualization is moving window.",
  "memoryTrick": "Sliding Window: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact moving window walkthrough for Sliding Window.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the moving window idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Sliding Window receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core moving window transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Sliding Window?",
    "options": [
      {
        "key": "A",
