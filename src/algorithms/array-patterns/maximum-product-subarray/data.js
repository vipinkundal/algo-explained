...
export const algorithmPage = {
  ...
  "meaning": "Maximum Product Subarray is a Array Patterns technique taught with a min max tracker dry run.",
  "problem": "It helps you recognize and solve the Maximum Product Subarray pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Maximum Product Subarray: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Maximum Product Subarray when a problem statement matches the Array Patterns pattern and the planned visualization is min max tracker.",
  "memoryTrick": "Maximum Product Subarray: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact min max tracker walkthrough for Maximum Product Subarray.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the min max tracker idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Maximum Product Subarray receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core min max tracker transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Maximum Product Subarray?",
    "options": [
      {
        "key": "A",
