...
export const algorithmPage = {
  ...
  "meaning": "Difference Array is a Array Patterns technique taught with a range update dry run.",
  "problem": "It helps you recognize and solve the Difference Array pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Difference Array: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Difference Array when a problem statement matches the Array Patterns pattern and the planned visualization is range update.",
  "memoryTrick": "Difference Array: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact range update walkthrough for Difference Array.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the range update idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Difference Array receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core range update transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Difference Array?",
    "options": [
      {
        "key": "A",
