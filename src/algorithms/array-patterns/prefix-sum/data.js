...
export const algorithmPage = {
  ...
  "meaning": "Prefix Sum is a Array Patterns technique taught with a cumulative array dry run.",
  "problem": "It helps you recognize and solve the Prefix Sum pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Prefix Sum: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Prefix Sum when a problem statement matches the Array Patterns pattern and the planned visualization is cumulative array.",
  "memoryTrick": "Prefix Sum: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact cumulative array walkthrough for Prefix Sum.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the cumulative array idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Prefix Sum receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core cumulative array transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Prefix Sum?",
    "options": [
      {
        "key": "A",
