...
export const algorithmPage = {
  ...
  "dryRun": [
    ...
    },
    {
      ...
      "activeLine": 3,
      "codeInsight": "Executes this Rotate Matrix line as part of the highlighted code path, linking the visual step to the implementation."
    },
    {
      "label": "Move/update",
    ...
    },
    {
      ...
      "activeLine": 11,
      "codeInsight": "Returns rotated, the value produced after Rotate Matrix's state changes are complete."
    }
  ],
  "complexity": {
  ...
  "animation": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "note": "The current row/column controls the next update.",
        "ruleLabel": "Rotate Matrix invariant",
        "rule": "Executes this Rotate Matrix line as part of the highlighted code path, linking the visual step to the implementation.",
        "activeCells": [
          [
            0,
            1
      ...
      },
      {
        ...
        "note": "The final matrix, count, or query answer is returned.",
        "ruleLabel": "Rotate Matrix invariant",
        "rule": "Returns rotated, the value produced after Rotate Matrix's state changes are complete.",
        "activeCells": [
          [
            1,
            1
