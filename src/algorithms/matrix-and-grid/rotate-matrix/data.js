...
export const algorithmPage = {
  ...
  "meaning": "Rotate Matrix is a Matrix and Grid technique taught with a grid transform dry run.",
  "problem": "It helps you recognize and solve the Rotate Matrix pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Rotate Matrix: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Rotate Matrix when a problem statement matches the Matrix and Grid pattern and the planned visualization is grid transform.",
  "memoryTrick": "Rotate Matrix: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact grid transform walkthrough for Rotate Matrix.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the grid transform idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Rotate Matrix receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core grid transform transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Rotate Matrix?",
    "options": [
      {
        "key": "A",
