...
export const algorithmPage = {
  ...
  "meaning": "Matrix Traversal is a Matrix and Grid technique taught with a grid walk dry run.",
  "problem": "It helps you recognize and solve the Matrix Traversal pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Matrix Traversal: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Matrix Traversal when a problem statement matches the Matrix and Grid pattern and the planned visualization is grid walk.",
  "memoryTrick": "Matrix Traversal: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact grid walk walkthrough for Matrix Traversal.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the grid walk idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Matrix Traversal receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core grid walk transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Matrix Traversal?",
    "options": [
      {
        "key": "A",
