...
export const algorithmPage = {
  ...
  "meaning": "Island Counting is a Matrix and Grid technique taught with a grid bfs dfs dry run.",
  "problem": "It helps you recognize and solve the Island Counting pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Island Counting: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Island Counting when a problem statement matches the Matrix and Grid pattern and the planned visualization is grid bfs dfs.",
  "memoryTrick": "Island Counting: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact grid bfs dfs walkthrough for Island Counting.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the grid bfs dfs idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Island Counting receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core grid bfs dfs transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Island Counting?",
    "options": [
      {
        "key": "A",
