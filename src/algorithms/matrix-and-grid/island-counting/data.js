...
export const algorithmPage = {
  ...
  "variables": [
    {
      "name": "input",
      "purpose": "The concrete data Island Counting receives before any state changes begin."
    },
    {
      "name": "state",
      "purpose": "The working information Island Counting updates while it runs."
    },
    {
      "name": "answer",
      "purpose": "The final value Island Counting returns after the stop condition is met."
    },
    {
      "name": "condition",
      "purpose": "The rule that decides whether Island Counting continues, branches, or stops."
    }
  ],
  "dryRun": [
    {
