...
export const algorithmPage = {
  ...
  "meaning": "Dynamic Programming Basics is a Foundations technique taught with a dp table dry run.",
  "problem": "It helps you recognize and solve the Dynamic Programming Basics pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Dynamic Programming Basics: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Dynamic Programming Basics when a problem statement matches the Foundations pattern and the planned visualization is dp table.",
  "memoryTrick": "Dynamic Programming Basics: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact dp table walkthrough for Dynamic Programming Basics.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the dp table idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Dynamic Programming Basics receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core dp table transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Dynamic Programming Basics?",
    "options": [
      {
        "key": "A",
