...
export const algorithmPage = {
  ...
  "meaning": "Greedy Basics is a Foundations technique taught with a decision timeline dry run.",
  "problem": "It helps you recognize and solve the Greedy Basics pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Greedy Basics: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Greedy Basics when a problem statement matches the Foundations pattern and the planned visualization is decision timeline.",
  "memoryTrick": "Greedy Basics: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact decision timeline walkthrough for Greedy Basics.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the decision timeline idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Greedy Basics receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core decision timeline transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Greedy Basics?",
    "options": [
      {
        "key": "A",
