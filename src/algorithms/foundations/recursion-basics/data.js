...
export const algorithmPage = {
  ...
  "meaning": "Recursion Basics is a Foundations technique taught with a call stack dry run.",
  "problem": "It helps you recognize and solve the Recursion Basics pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Recursion Basics: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Recursion Basics when a problem statement matches the Foundations pattern and the planned visualization is call stack.",
  "memoryTrick": "Recursion Basics: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact call stack walkthrough for Recursion Basics.",
  "logicSteps": [
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Recursion Basics receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Recursion Basics?",
    "options": [
      {
        "key": "A",
