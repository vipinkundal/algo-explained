...
export const algorithmPage = {
  ...
  "meaning": "Backtracking Basics is a Foundations technique taught with a recursion tree dry run.",
  "problem": "It helps you recognize and solve the Backtracking Basics pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Backtracking Basics: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Backtracking Basics when a problem statement matches the Foundations pattern and the planned visualization is recursion tree.",
  "memoryTrick": "Backtracking Basics: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact recursion tree walkthrough for Backtracking Basics.",
  "logicSteps": [
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Backtracking Basics receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Backtracking Basics?",
    "options": [
      {
        "key": "A",
