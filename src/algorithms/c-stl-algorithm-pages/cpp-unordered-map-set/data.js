...
export const algorithmPage = {
  ...
  "meaning": "C++ unordered_map / unordered_set is a C++ STL Algorithm Pages technique taught with a hash table dry run.",
  "problem": "It helps you recognize and solve the C++ unordered_map / unordered_set pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for C++ unordered_map / unordered_set: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use C++ unordered_map / unordered_set when a problem statement matches the C++ STL Algorithm Pages pattern and the planned visualization is hash table.",
  "memoryTrick": "C++ unordered_map / unordered_set: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact hash table walkthrough for C++ unordered_map / unordered_set.",
  "logicSteps": [
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what C++ unordered_map / unordered_set receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
  ...
  "quiz": {
    "question": "What is the safest first step when applying C++ unordered_map / unordered_set?",
    "options": [
      {
        "key": "A",
