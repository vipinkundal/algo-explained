  ...
  "dryRun": [
    {
      ...
      "activeLine": 5,
      "codeInsight": "Defines cppUpperBound and names the input values, target; edits to those inputs change the visual state and output."
    },
    {
      "label": "low / high",
    ...
    },
    {
      ...
      "activeLine": 13,
      "codeInsight": "Returns low, the final value maintained by C++ upper_bound()'s code path."
    }
  ],
  "complexity": {
    ...
    "steps": [
      {
        ...
        "rule": "Defines cppUpperBound and names the input values, target; edits to those inputs change the visual state and output.",
        "activeIndices": [
          0
        ],
        "sortedIndices": [],
      ...
      },
      {
        ...
        "note": "The loop ends with a match or the collapsed boundary.",
        "ruleLabel": "C++ upper_bound() invariant",
        "rule": "Returns low, the final value maintained by C++ upper_bound()'s code path.",
        "activeIndices": [
          3,
          3
        ],
