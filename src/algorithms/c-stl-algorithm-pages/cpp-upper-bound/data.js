...
export const algorithmPage = {
  ...
  "concept": "C++ upper_bound() narrows where a target can be by scanning or shrinking a candidate interval.",
  ...
  "memoryTrick": "C++ upper_bound(): name the input, state, answer, and stop condition before writing the loop.",
  "visualizerCaption": "A array boundaries walkthrough showing C++ upper_bound()'s input, state, transition, and answer.",
  "logicSteps": [
    {
      "title": "Read the input",
      "text": "Identify the exact data C++ upper_bound() receives and what output is required."
    },
    {
      "title": "Initialize state",
      "text": "Prepare the working variables used only by C++ upper_bound()."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Read the C++ upper_bound() input and decide what result must be produced.",
      "activeLine": 1
    },
    {
      "label": "State",
      "title": "Initialize working state",
      "note": "Set up the state variables that C++ upper_bound() changes during the dry run.",
      "activeLine": 3
    },
    {
      "label": "Transition",
      "title": "Run the core step",
      "note": "Apply one array boundaries transition for C++ upper_bound().",
      "activeLine": 5
    },
    {
      "label": "Answer",
      "title": "Return the result",
      "note": "Return the final C++ upper_bound() answer from the tracked state.",
      "activeLine": 8
    }
  ],
  "complexity": {
