...
export const algorithmPage = {
  ...
  "meaning": "C++ upper_bound() is a C++ STL Algorithm Pages technique taught with a array boundaries dry run.",
  "problem": "It helps you recognize and solve the C++ upper_bound() pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for C++ upper_bound(): inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use C++ upper_bound() when a problem statement matches the C++ STL Algorithm Pages pattern and the planned visualization is array boundaries.",
  "memoryTrick": "C++ upper_bound(): name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact array boundaries walkthrough for C++ upper_bound().",
  "logicSteps": [
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what C++ upper_bound() receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
  ...
  "quiz": {
    "question": "What is the safest first step when applying C++ upper_bound()?",
    "options": [
      {
        "key": "A",
