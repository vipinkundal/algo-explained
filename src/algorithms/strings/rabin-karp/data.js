...
export const algorithmPage = {
  ...
  "meaning": "Rabin-Karp Algorithm is a Strings technique taught with a rolling hash dry run.",
  "problem": "It helps you recognize and solve the Rabin-Karp Algorithm pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Rabin-Karp Algorithm: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Rabin-Karp Algorithm when a problem statement matches the Strings pattern and the planned visualization is rolling hash.",
  "memoryTrick": "Rabin-Karp Algorithm: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact rolling hash walkthrough for Rabin-Karp Algorithm.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the rolling hash idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Rabin-Karp Algorithm receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core rolling hash transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Rabin-Karp Algorithm?",
    "options": [
      {
        "key": "A",
