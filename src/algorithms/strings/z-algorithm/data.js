  ...
  "variables": [
    {
      ...
      "purpose": "The concrete data Z Algorithm receives before any state changes begin."
    },
    {
      "name": "indices and prefix/hash state",
      "purpose": "The working information Z Algorithm updates while it runs."
    },
    {
      "name": "matches or string result",
      "purpose": "The final value Z Algorithm returns after the stop condition is met."
    },
    {
      "name": "characters remain",
      "purpose": "The rule that decides whether Z Algorithm continues, branches, or stops."
    }
  ],
  "dryRun": [
    {
