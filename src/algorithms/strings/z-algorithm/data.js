...
export const algorithmPage = {
  ...
  "meaning": "Z Algorithm is a Strings technique taught with a z box dry run.",
  "problem": "It helps you recognize and solve the Z Algorithm pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Z Algorithm: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Z Algorithm when a problem statement matches the Strings pattern and the planned visualization is z box.",
  "memoryTrick": "Z Algorithm: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact z box walkthrough for Z Algorithm.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the z box idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Z Algorithm receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core z box transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Z Algorithm?",
    "options": [
      {
        "key": "A",
