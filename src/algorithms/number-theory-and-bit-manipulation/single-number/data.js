...
export const algorithmPage = {
  ...
  "meaning": "Single Number is a Number Theory and Bit Manipulation technique taught with a xor cancel dry run.",
  "problem": "It helps you recognize and solve the Single Number pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Single Number: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Single Number when a problem statement matches the Number Theory and Bit Manipulation pattern and the planned visualization is xor cancel.",
  "memoryTrick": "Single Number: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact xor cancel walkthrough for Single Number.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the xor cancel idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Single Number receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core xor cancel transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Single Number?",
    "options": [
      {
        "key": "A",
