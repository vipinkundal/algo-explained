...
export const algorithmPage = {
  ...
  "meaning": "Fast Power is a Number Theory and Bit Manipulation technique taught with a binary power dry run.",
  "problem": "It helps you recognize and solve the Fast Power pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Fast Power: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Fast Power when a problem statement matches the Number Theory and Bit Manipulation pattern and the planned visualization is binary power.",
  "memoryTrick": "Fast Power: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact binary power walkthrough for Fast Power.",
  "logicSteps": [
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Fast Power receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Fast Power?",
    "options": [
      {
        "key": "A",
