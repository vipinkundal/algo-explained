...
export const algorithmPage = {
  ...
  "memoryTrick": "Modular Exponentiation: name the invariant, then trace the exact state change.",
  "visualizerCaption": "Modular Exponentiation is shown as arithmetic-state reduction. The numbered steps follow the code path used to maintain the main invariant.",
  "logicSteps": [
    {
      "title": "Read numbers",
