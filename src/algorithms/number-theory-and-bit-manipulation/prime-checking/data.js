...
export const algorithmPage = {
  ...
  "meaning": "Prime Checking is a Number Theory and Bit Manipulation technique taught with a divisor scan dry run.",
  "problem": "It helps you recognize and solve the Prime Checking pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Prime Checking: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Prime Checking when a problem statement matches the Number Theory and Bit Manipulation pattern and the planned visualization is divisor scan.",
  "memoryTrick": "Prime Checking: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact divisor scan walkthrough for Prime Checking.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the divisor scan idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Prime Checking receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core divisor scan transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Prime Checking?",
    "options": [
      {
        "key": "A",
