...
export const algorithmPage = {
  ...
  "meaning": "GCD / Euclidean Algorithm is a Number Theory and Bit Manipulation technique taught with a remainder steps dry run.",
  "problem": "It helps you recognize and solve the GCD / Euclidean Algorithm pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for GCD / Euclidean Algorithm: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use GCD / Euclidean Algorithm when a problem statement matches the Number Theory and Bit Manipulation pattern and the planned visualization is remainder steps.",
  "memoryTrick": "GCD / Euclidean Algorithm: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact remainder steps walkthrough for GCD / Euclidean Algorithm.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the remainder steps idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what GCD / Euclidean Algorithm receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core remainder steps transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying GCD / Euclidean Algorithm?",
    "options": [
      {
        "key": "A",
