...
export const algorithmPage = {
  ...
  "variables": [
    {
      "name": "input",
      "purpose": "The concrete data Power of Two receives before any state changes begin."
    },
    {
      "name": "state",
      "purpose": "The working information Power of Two updates while it runs."
    },
    {
      "name": "answer",
      "purpose": "The final value Power of Two returns after the stop condition is met."
    },
    {
      "name": "condition",
      "purpose": "The rule that decides whether Power of Two continues, branches, or stops."
    }
  ],
  "dryRun": [
    {
