...
export const algorithmPage = {
  ...
  "meaning": "Power of Two is a Number Theory and Bit Manipulation technique taught with a bit check dry run.",
  "problem": "It helps you recognize and solve the Power of Two pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Power of Two: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Power of Two when a problem statement matches the Number Theory and Bit Manipulation pattern and the planned visualization is bit check.",
  "memoryTrick": "Power of Two: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact bit check walkthrough for Power of Two.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the bit check idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Power of Two receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core bit check transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Power of Two?",
    "options": [
      {
        "key": "A",
