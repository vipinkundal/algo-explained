...
export const algorithmPage = {
  ...
  "meaning": "Modular Inverse is a Number Theory and Bit Manipulation technique taught with a extended gcd dry run.",
  "problem": "It helps you recognize and solve the Modular Inverse pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Modular Inverse: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Modular Inverse when a problem statement matches the Number Theory and Bit Manipulation pattern and the planned visualization is extended gcd.",
  "memoryTrick": "Modular Inverse: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact extended gcd walkthrough for Modular Inverse.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the extended gcd idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Modular Inverse receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core extended gcd transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Modular Inverse?",
    "options": [
      {
        "key": "A",
