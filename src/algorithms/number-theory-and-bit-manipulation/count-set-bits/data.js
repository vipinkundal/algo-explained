...
export const algorithmPage = {
  ...
  "meaning": "Count Set Bits is a Number Theory and Bit Manipulation technique taught with a bit count dry run.",
  "problem": "It helps you recognize and solve the Count Set Bits pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Count Set Bits: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Count Set Bits when a problem statement matches the Number Theory and Bit Manipulation pattern and the planned visualization is bit count.",
  "memoryTrick": "Count Set Bits: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact bit count walkthrough for Count Set Bits.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the bit count idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Count Set Bits receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core bit count transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Count Set Bits?",
    "options": [
      {
        "key": "A",
