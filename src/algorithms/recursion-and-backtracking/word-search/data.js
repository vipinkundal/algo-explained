...
export const algorithmPage = {
  ...
  "meaning": "Word Search is a Recursion and Backtracking technique taught with a grid dfs dry run.",
  "problem": "It helps you recognize and solve the Word Search pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Word Search: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Word Search when a problem statement matches the Recursion and Backtracking pattern and the planned visualization is grid dfs.",
  "memoryTrick": "Word Search: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact grid dfs walkthrough for Word Search.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the grid dfs idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Word Search receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core grid dfs transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Word Search?",
    "options": [
      {
        "key": "A",
