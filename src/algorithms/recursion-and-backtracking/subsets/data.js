  ...
  "dryRun": [
    {
      ...
      "activeLine": 1,
      "codeInsight": "Executes this Subsets line as part of the highlighted code path, linking the visual step to the implementation."
    },
    {
      "label": "Choice",
      ...
      "activeLine": 4,
      "codeInsight": "This blank line separates Subsets's setup from the next code block."
    },
    {
      "label": "Call",
    ...
    "steps": [
      {
        ...
        "rule": "Executes this Subsets line as part of the highlighted code path, linking the visual step to the implementation.",
        "activeNode": "8",
        "targetNode": "4",
        "replacementNode": "",
        "mutedNodes": [
      ...
      },
      {
        ...
        "note": "One valid move is added to the state.",
        "ruleLabel": "Subsets invariant",
        "rule": "This blank line separates Subsets's setup from the next code block.",
        "activeNode": "4",
        "targetNode": "12",
        "replacementNode": "",
        "mutedNodes": [
