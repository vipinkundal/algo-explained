...
export const algorithmPage = {
  ...
  "meaning": "Subsets is a Recursion and Backtracking technique taught with a decision tree dry run.",
  "problem": "It helps you recognize and solve the Subsets pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Subsets: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Subsets when a problem statement matches the Recursion and Backtracking pattern and the planned visualization is decision tree.",
  "memoryTrick": "Subsets: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact decision tree walkthrough for Subsets.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the decision tree idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Subsets receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core decision tree transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Subsets?",
    "options": [
      {
        "key": "A",
