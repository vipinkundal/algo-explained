...
export const algorithmPage = {
  ...
  "meaning": "Factorial Recursion is a Recursion and Backtracking technique taught with a call stack dry run.",
  "problem": "It helps you recognize and solve the Factorial Recursion pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Factorial Recursion: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Factorial Recursion when a problem statement matches the Recursion and Backtracking pattern and the planned visualization is call stack.",
  "memoryTrick": "Factorial Recursion: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact call stack walkthrough for Factorial Recursion.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the call stack idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Factorial Recursion receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core call stack transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Factorial Recursion?",
    "options": [
      {
        "key": "A",
