...
export const algorithmPage = {
  ...
  "meaning": "Fibonacci Recursion is a Recursion and Backtracking technique taught with a recursion tree dry run.",
  "problem": "It helps you recognize and solve the Fibonacci Recursion pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Fibonacci Recursion: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Fibonacci Recursion when a problem statement matches the Recursion and Backtracking pattern and the planned visualization is recursion tree.",
  "memoryTrick": "Fibonacci Recursion: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact recursion tree walkthrough for Fibonacci Recursion.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the recursion tree idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Fibonacci Recursion receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core recursion tree transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Fibonacci Recursion?",
    "options": [
      {
        "key": "A",
