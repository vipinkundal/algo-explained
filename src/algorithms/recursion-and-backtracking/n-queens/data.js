...
export const algorithmPage = {
  ...
  "meaning": "N-Queens is a Recursion and Backtracking technique taught with a chessboard dry run.",
  "problem": "It helps you recognize and solve the N-Queens pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for N-Queens: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use N-Queens when a problem statement matches the Recursion and Backtracking pattern and the planned visualization is chessboard.",
  "memoryTrick": "N-Queens: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact chessboard walkthrough for N-Queens.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the chessboard idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what N-Queens receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core chessboard transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying N-Queens?",
    "options": [
      {
        "key": "A",
