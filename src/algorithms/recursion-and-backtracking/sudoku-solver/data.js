...
export const algorithmPage = {
  ...
  "meaning": "Sudoku Solver is a Recursion and Backtracking technique taught with a board state dry run.",
  "problem": "It helps you recognize and solve the Sudoku Solver pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Sudoku Solver: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Sudoku Solver when a problem statement matches the Recursion and Backtracking pattern and the planned visualization is board state.",
  "memoryTrick": "Sudoku Solver: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact board state walkthrough for Sudoku Solver.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the board state idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Sudoku Solver receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core board state transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Sudoku Solver?",
    "options": [
      {
        "key": "A",
