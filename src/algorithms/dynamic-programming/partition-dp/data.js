...
export const algorithmPage = {
  ...
  "meaning": "Partition DP is a Dynamic Programming technique taught with a partition table dry run.",
  "problem": "It helps you recognize and solve the Partition DP pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Partition DP: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Partition DP when a problem statement matches the Dynamic Programming pattern and the planned visualization is partition table.",
  "memoryTrick": "Partition DP: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact partition table walkthrough for Partition DP.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the partition table idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Partition DP receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core partition table transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Partition DP?",
    "options": [
      {
        "key": "A",
