...
export const algorithmPage = {
  ...
  "meaning": "Matrix Chain Multiplication is a Dynamic Programming technique taught with a interval dp dry run.",
  "problem": "It helps you recognize and solve the Matrix Chain Multiplication pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Matrix Chain Multiplication: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Matrix Chain Multiplication when a problem statement matches the Dynamic Programming pattern and the planned visualization is interval dp.",
  "memoryTrick": "Matrix Chain Multiplication: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact interval dp walkthrough for Matrix Chain Multiplication.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the interval dp idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Matrix Chain Multiplication receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core interval dp transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Matrix Chain Multiplication?",
    "options": [
      {
        "key": "A",
