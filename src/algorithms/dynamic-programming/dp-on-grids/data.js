...
export const algorithmPage = {
  ...
  "meaning": "DP on Grids is a Dynamic Programming technique taught with a grid path dp dry run.",
  "problem": "It helps you recognize and solve the DP on Grids pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for DP on Grids: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use DP on Grids when a problem statement matches the Dynamic Programming pattern and the planned visualization is grid path dp.",
  "memoryTrick": "DP on Grids: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact grid path dp walkthrough for DP on Grids.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the grid path dp idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what DP on Grids receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core grid path dp transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying DP on Grids?",
    "options": [
      {
        "key": "A",
