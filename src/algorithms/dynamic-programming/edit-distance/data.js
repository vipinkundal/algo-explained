...
export const algorithmPage = {
  ...
  "meaning": "Edit Distance is a Dynamic Programming technique taught with a dp grid dry run.",
  "problem": "It helps you recognize and solve the Edit Distance pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Edit Distance: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Edit Distance when a problem statement matches the Dynamic Programming pattern and the planned visualization is dp grid.",
  "memoryTrick": "Edit Distance: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact dp grid walkthrough for Edit Distance.",
  "logicSteps": [
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Edit Distance receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Edit Distance?",
    "options": [
      {
        "key": "A",
