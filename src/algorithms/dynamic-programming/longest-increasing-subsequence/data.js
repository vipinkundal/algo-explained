...
export const algorithmPage = {
  ...
  "meaning": "Longest Increasing Subsequence is a Dynamic Programming technique taught with a sequence dp dry run.",
  "problem": "It helps you recognize and solve the Longest Increasing Subsequence pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Longest Increasing Subsequence: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Longest Increasing Subsequence when a problem statement matches the Dynamic Programming pattern and the planned visualization is sequence dp.",
  "memoryTrick": "Longest Increasing Subsequence: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact sequence dp walkthrough for Longest Increasing Subsequence.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the sequence dp idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Longest Increasing Subsequence receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core sequence dp transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Longest Increasing Subsequence?",
    "options": [
      {
        "key": "A",
