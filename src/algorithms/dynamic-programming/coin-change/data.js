...
export const algorithmPage = {
  ...
  "meaning": "Coin Change is a Dynamic Programming technique taught with a dp array dry run.",
  "problem": "It helps you recognize and solve the Coin Change pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Coin Change: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Coin Change when a problem statement matches the Dynamic Programming pattern and the planned visualization is dp array.",
  "memoryTrick": "Coin Change: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact dp array walkthrough for Coin Change.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the dp array idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Coin Change receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core dp array transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Coin Change?",
    "options": [
      {
        "key": "A",
