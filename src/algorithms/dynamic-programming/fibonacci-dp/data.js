...
export const algorithmPage = {
  ...
  "meaning": "Fibonacci DP is a Dynamic Programming technique taught with a dp table dry run.",
  "problem": "It helps you recognize and solve the Fibonacci DP pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Fibonacci DP: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Fibonacci DP when a problem statement matches the Dynamic Programming pattern and the planned visualization is dp table.",
  "memoryTrick": "Fibonacci DP: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact dp table walkthrough for Fibonacci DP.",
  "logicSteps": [
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Fibonacci DP receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Fibonacci DP?",
    "options": [
      {
        "key": "A",
