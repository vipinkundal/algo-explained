...
export const algorithmPage = {
  ...
  "meaning": "Max Heap is a Heap and Priority Queue technique taught with a heap tree dry run.",
  "problem": "It helps you recognize and solve the Max Heap pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Max Heap: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Max Heap when a problem statement matches the Heap and Priority Queue pattern and the planned visualization is heap tree.",
  "memoryTrick": "Max Heap: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact heap tree walkthrough for Max Heap.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the heap tree idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Max Heap receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core heap tree transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Max Heap?",
    "options": [
      {
        "key": "A",
