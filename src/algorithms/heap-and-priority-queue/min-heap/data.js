...
export const algorithmPage = {
  ...
  "meaning": "Min Heap is a Heap and Priority Queue technique taught with a heap tree dry run.",
  "problem": "It helps you recognize and solve the Min Heap pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Min Heap: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Min Heap when a problem statement matches the Heap and Priority Queue pattern and the planned visualization is heap tree.",
  "memoryTrick": "Min Heap: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact heap tree walkthrough for Min Heap.",
  "logicSteps": [
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Min Heap receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Min Heap?",
    "options": [
      {
        "key": "A",
