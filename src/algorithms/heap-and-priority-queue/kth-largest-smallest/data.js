...
export const algorithmPage = {
  ...
  "meaning": "Kth Largest / Smallest Element is a Heap and Priority Queue technique taught with a heap selection dry run.",
  "problem": "It helps you recognize and solve the Kth Largest / Smallest Element pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Kth Largest / Smallest Element: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Kth Largest / Smallest Element when a problem statement matches the Heap and Priority Queue pattern and the planned visualization is heap selection.",
  "memoryTrick": "Kth Largest / Smallest Element: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact heap selection walkthrough for Kth Largest / Smallest Element.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the heap selection idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Kth Largest / Smallest Element receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core heap selection transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Kth Largest / Smallest Element?",
    "options": [
      {
        "key": "A",
