...
export const algorithmPage = {
  ...
  "variables": [
    {
      "name": "values, index, size",
      "purpose": "values: The candidate values that drive the heap, recursion, subset, or frequency process. index: The index input used by the algorithm. size: A numeric limit that controls the window, heap, bucket, or selected result size."
    },
    {
      "name": "heap array",
    ...
    },
    {
      ...
      "purpose": "The value produced by heapify after the maintained state reaches the stop rule."
    },
    {
