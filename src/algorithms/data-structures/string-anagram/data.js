...
export const algorithmPage = {
  ...
  "visualizerCaption": "A string scan walkthrough for String Anagram.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values String Anagram needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that String Anagram needs to inspect or change.",
      "activeLine": 1,
