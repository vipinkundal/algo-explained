...
export const algorithmPage = {
  ...
  "visualizerCaption": "A call stack walkthrough for Recursion nCr.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values Recursion nCr needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that Recursion nCr needs to inspect or change.",
      "activeLine": 1,
