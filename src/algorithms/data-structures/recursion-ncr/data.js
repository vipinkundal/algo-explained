...
export const algorithmPage = {
  ...
  "meaning": "Recursion nCr shows how data is organized, changed, and inspected through a small browser demo with a C/C++ reference available beside it.",
  ...
  "dryRun": [
    ...
    },
    {
      ...
      "activeLine": 6,
      "codeInsight": "Returns value <= 1 ? 1 : value * factorial(value - 1), the value produced after Recursion nCr's state changes are complete."
    }
  ],
  "complexity": {
  ...
  "animation": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "note": "The return value or printed state confirms the operation.",
        "ruleLabel": "Recursion nCr invariant",
        "rule": "Returns value <= 1 ? 1 : value * factorial(value - 1), the value produced after Recursion nCr's state changes are complete.",
        "activeCall": 3,
        "returningCalls": [
          0,
          1,
