...
export const algorithmPage = {
  ...
  "meaning": "String Changing Case shows how data is organized, changed, and inspected through a small browser demo with the original C/C++ reference available beside it.",
  ...
  "visualizerCaption": "A string scan walkthrough for String Changing Case.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values String Changing Case needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that String Changing Case needs to inspect or change.",
      "activeLine": 1,
