...
export const algorithmPage = {
  ...
  "visualizerCaption": "A cpp memory model walkthrough for C/C++ Functions.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values C/C++ Functions needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that C/C++ Functions needs to inspect or change.",
      "activeLine": 1,
