...
export const algorithmPage = {
  ...
  "dryRun": [
    ...
    },
    {
      ...
      "activeLine": 6,
      "codeInsight": "Executes this Lower Triangular Matrix line as part of the highlighted code path, linking the visual step to the implementation."
    },
    {
      "label": "Result",
      ...
      "activeLine": 5,
      "codeInsight": "Returns { structure: \"matrix\", representation: \"non-zero entries\", nonZero }, the value produced after Lower Triangular Matrix's state changes are complete."
    }
  ],
  "complexity": {
  ...
  "animation": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "note": "The transition changes reachable cells, boundaries, or accumulated values.",
        "ruleLabel": "Lower Triangular Matrix invariant",
        "rule": "Executes this Lower Triangular Matrix line as part of the highlighted code path, linking the visual step to the implementation.",
        "activeCells": [
          [
            0,
            2
      ...
      },
      {
        ...
        "note": "The final matrix, count, or query answer is returned.",
        "ruleLabel": "Lower Triangular Matrix invariant",
        "rule": "Returns { structure: \"matrix\", representation: \"non-zero entries\", nonZero }, the value produced after Lower Triangular Matrix's state changes are complete.",
        "activeCells": [
          [
            1,
            0
