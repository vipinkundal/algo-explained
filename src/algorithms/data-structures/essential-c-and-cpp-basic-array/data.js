...
export const algorithmPage = {
  ...
  "visualizerCaption": "A cpp memory model walkthrough for C/C++ Basic Array.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values C/C++ Basic Array needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that C/C++ Basic Array needs to inspect or change.",
      "activeLine": 1,
