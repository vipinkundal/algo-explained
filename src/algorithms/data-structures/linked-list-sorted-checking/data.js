...
export const algorithmPage = {
  ...
  "meaning": "Linked List Sorted Checking shows how data is organized, changed, and inspected through a small browser demo with the original C/C++ reference available beside it.",
  ...
  "visualizerCaption": "A linked list walkthrough for Linked List Sorted Checking.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values Linked List Sorted Checking needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that Linked List Sorted Checking needs to inspect or change.",
      "activeLine": 1,
