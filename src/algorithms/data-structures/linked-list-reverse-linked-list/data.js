...
export const algorithmPage = {
  ...
  "visualizerCaption": "A linked list walkthrough for Reverse Linked List.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values Reverse Linked List needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that Reverse Linked List needs to inspect or change.",
      "activeLine": 1,
