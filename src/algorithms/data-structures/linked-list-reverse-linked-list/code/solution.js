// Runnable JavaScript companion for Reverse Linked List
// Original source: 09_Linked_list/11_Reverse_Linked_list.cpp
export function linkedListReverseLinkedList() {
