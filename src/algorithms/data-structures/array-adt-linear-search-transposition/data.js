...
export const algorithmPage = {
  ...
  "meaning": "Linear Search in Array ADT with Transposition shows how data is organized, changed, and inspected through a small browser demo with the original C/C++ reference available beside it.",
  ...
  "visualizerCaption": "An array adt walkthrough for Linear Search in Array ADT with Transposition.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values Linear Search in Array ADT with Transposition needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that Linear Search in Array ADT with Transposition needs to inspect or change.",
      "activeLine": 1,
