...
export const algorithmPage = {
  ...
  "meaning": "C/C++ Monolithic Program shows how data is organized, changed, and inspected through a small browser demo with a C/C++ reference available beside it.",
  ...
  "dryRun": [
    {
      ...
      "activeLine": 1,
      "codeInsight": "Executes this C/C++ Monolithic Program line as part of the highlighted code path, linking the visual step to the implementation."
    },
    {
      "label": "Storage",
    ...
    },
    {
      ...
      "activeLine": 3,
      "codeInsight": "Returns {, the value produced after C/C++ Monolithic Program's state changes are complete."
    }
  ],
  "complexity": {
    ...
    "steps": [
      {
        ...
        "rule": "Executes this C/C++ Monolithic Program line as part of the highlighted code path, linking the visual step to the implementation.",
        "activeState": 0
      },
      {
        "phase": "Storage",
      ...
      },
      {
        ...
        "note": "The visible output follows from the memory model.",
        "ruleLabel": "C/C++ Monolithic Program invariant",
        "rule": "Returns {, the value produced after C/C++ Monolithic Program's state changes are complete.",
        "activeState": 3
      }
    ]
  }
