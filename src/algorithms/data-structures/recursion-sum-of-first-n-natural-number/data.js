...
export const algorithmPage = {
  ...
  "visualizerCaption": "A call stack walkthrough for Recursion Sum Of First N Natural Number.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values Recursion Sum Of First N Natural Number needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that Recursion Sum Of First N Natural Number needs to inspect or change.",
      "activeLine": 1,
