...
export const algorithmPage = {
  ...
  "meaning": "Balanced Parentheses with Stack shows how data is organized, changed, and inspected through a small browser demo with a C/C++ reference available beside it.",
  "problem": "Balanced Parentheses with Stack explains the stack state model and how one focused change updates it.",
  "concept": "Balanced Parentheses with Stack is useful when stack behavior is the clearest model for the data changes. Use this when the problem is naturally described by last-in, first-out state.",
  ...
  "realLifeExample": "Balanced Parentheses with Stack is useful when you need to understand the mechanics behind library-level data structures.",
  "whenToUse": "Use this page when learning Stack behavior through state changes instead of memorized code.",
  "memoryTrick": "Balanced Parentheses with Stack: name the invariant, then trace the exact state change.",
  "visualizerCaption": "Balanced Parentheses with Stack is shown as stack state changes. The numbered steps follow the code path used to maintain the main invariant.",
  "logicSteps": [
    {
      "title": "Read stack",
  ...
  "variables": [
    ...
    {
      "name": "stack slots",
      "purpose": "The ordered storage used by Balanced Parentheses with Stack."
    },
    {
      "name": "popped item",
  ...
  "dryRun": [
    ...
    },
    {
      ...
      "activeLine": 7,
      "codeInsight": "Returns { structure: \"stack\", invariant: \"last in, first out\", state: stack, popped: output }, the value produced after Balanced Parentheses with Stack's state changes are complete."
    }
  ],
  "complexity": {
  ...
  "animation": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "note": "The return value or printed state confirms the operation.",
        "ruleLabel": "Balanced Parentheses with Stack invariant",
        "rule": "Returns { structure: \"stack\", invariant: \"last in, first out\", state: stack, popped: output }, the value produced after Balanced Parentheses with Stack's state changes are complete.",
        "activeItems": [
          3
        ],
        "topIndex": 3,
