...
export const algorithmPage = {
  ...
  "visualizerCaption": "A stack operations walkthrough for Balanced Parentheses with Stack.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values Balanced Parentheses with Stack needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that Balanced Parentheses with Stack needs to inspect or change.",
      "activeLine": 1,
