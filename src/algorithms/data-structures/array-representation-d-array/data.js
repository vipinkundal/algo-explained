...
export const algorithmPage = {
  ...
  "meaning": "D Array shows how data is organized, changed, and inspected through a small browser demo with a C/C++ reference available beside it.",
  "problem": "D Array explains the array state model and how one focused change updates it.",
  "concept": "D Array is useful when contiguous storage, indexes, length, or capacity explain the operation. Use this when an array operation depends on slot position, bounds, or shifting values.",
  ...
  "realLifeExample": "D Array is useful when you need to understand the mechanics behind library-level data structures.",
  "whenToUse": "Use this page when learning Arrays / Array ADT behavior through state changes instead of memorized code.",
  "memoryTrick": "D Array: name the invariant, then trace the exact state change.",
  "visualizerCaption": "D Array is shown as indexed array state changes. The numbered steps follow the code path used to maintain the main invariant.",
  "logicSteps": [
    {
      "title": "Read request",
  ...
  "variables": [
    ...
    {
      "name": "array view",
      "purpose": "Shows the slots after D Array applies its operation."
    }
  ],
  "dryRun": [
    {
    ...
    },
    {
      ...
      "activeLine": 6,
      "codeInsight": "Executes this D Array line as part of the highlighted code path, linking the visual step to the implementation."
    },
    {
      "label": "Result",
      ...
      "activeLine": 5,
      "codeInsight": "Returns { structure: \"array\", values, length: values.length, max: Math.max(...values), sum }, the value produced after D Array's state changes are complete."
    }
  ],
  "complexity": {
  ...
  "animation": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "note": "The operation sets, shifts, scans, or resizes array slots.",
        "ruleLabel": "D Array invariant",
        "rule": "Executes this D Array line as part of the highlighted code path, linking the visual step to the implementation.",
        "activeIndices": [
          2
        ],
        "sortedIndices": [],
      ...
      },
      {
        ...
        "note": "The visible value or updated array confirms the operation.",
        "ruleLabel": "D Array invariant",
        "rule": "Returns { structure: \"array\", values, length: values.length, max: Math.max(...values), sum }, the value produced after D Array's state changes are complete.",
        "activeIndices": [
          3,
          4
        ],
