...
export const algorithmPage = {
  ...
  "visualizerCaption": "An array memory walkthrough for D Array.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values D Array needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that D Array needs to inspect or change.",
      "activeLine": 1,
