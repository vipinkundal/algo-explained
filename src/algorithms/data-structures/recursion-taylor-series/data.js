...
export const algorithmPage = {
  ...
  "meaning": "Recursion Taylor Series shows how data is organized, changed, and inspected through a small browser demo with a C/C++ reference available beside it.",
  "problem": "Recursion Taylor Series explains the recursive call state model and how one focused change updates it.",
  "concept": "Recursion Taylor Series is useful when stack behavior is the clearest model for the data changes. Use this when the problem is naturally described by last-in, first-out state.",
  ...
  "realLifeExample": "Recursion Taylor Series is useful when you need to understand the mechanics behind library-level data structures.",
  "whenToUse": "Use this page when learning Recursion behavior through state changes instead of memorized code.",
  "memoryTrick": "Recursion Taylor Series: name the invariant, then trace the exact state change.",
  "visualizerCaption": "Recursion Taylor Series is shown as stack state changes. The numbered steps follow the code path used to maintain the main invariant.",
  "logicSteps": [
    {
      "title": "Read stack",
  ...
  "variables": [
    ...
    {
      "name": "final value",
      "purpose": "The answer produced by Recursion Taylor Series."
    }
  ],
  "dryRun": [
    {
    ...
    },
    {
      ...
      "activeLine": 6,
      "codeInsight": "Returns value <= 1 ? 1 : value * factorial(value - 1), the value produced after Recursion Taylor Series's state changes are complete."
    }
  ],
  "complexity": {
  ...
  "animation": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "note": "The return value or printed state confirms the operation.",
        "ruleLabel": "Recursion Taylor Series invariant",
        "rule": "Returns value <= 1 ? 1 : value * factorial(value - 1), the value produced after Recursion Taylor Series's state changes are complete.",
        "activeCall": 3,
        "returningCalls": [
          0,
          1,
