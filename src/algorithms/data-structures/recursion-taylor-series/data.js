...
export const algorithmPage = {
  ...
  "visualizerCaption": "A call stack walkthrough for Recursion Taylor Series.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values Recursion Taylor Series needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that Recursion Taylor Series needs to inspect or change.",
      "activeLine": 1,
