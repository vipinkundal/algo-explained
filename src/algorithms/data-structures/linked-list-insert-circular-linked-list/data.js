...
export const algorithmPage = {
  ...
  "visualizerCaption": "A linked list walkthrough for Insert Circular Linked List.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values Insert Circular Linked List needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that Insert Circular Linked List needs to inspect or change.",
      "activeLine": 1,
