...
export const algorithmPage = {
  ...
  "dryRun": [
    ...
    },
    {
      ...
      "activeLine": 6,
      "codeInsight": "Returns value <= 1 ? 1 : value * factorial(value - 1), the value produced after First Recursion Program's state changes are complete."
    }
  ],
  "complexity": {
  ...
  "animation": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "note": "The return value or printed state confirms the operation.",
        "ruleLabel": "First Recursion Program invariant",
        "rule": "Returns value <= 1 ? 1 : value * factorial(value - 1), the value produced after First Recursion Program's state changes are complete.",
        "activeCall": 3,
        "returningCalls": [
          0,
          1,
