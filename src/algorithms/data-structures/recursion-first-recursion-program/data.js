...
export const algorithmPage = {
  ...
  "meaning": "First Recursion Program shows how data is organized, changed, and inspected through a small browser demo with the original C/C++ reference available beside it.",
  ...
  "originalCodeInsight": "The original First Recursion Program source shows the C/C++ memory model and operation order used by this lesson.",
  ...
  "visualizerCaption": "A call stack walkthrough for First Recursion Program.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values First Recursion Program needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that First Recursion Program needs to inspect or change.",
      "activeLine": 1,
