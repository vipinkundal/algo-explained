...
export const algorithmPage = {
  ...
  "meaning": "Static Variable In Recursion shows how data is organized, changed, and inspected through a small browser demo with the original C/C++ reference available beside it.",
  ...
  "originalCodeInsight": "The original Static Variable In Recursion source shows the C/C++ memory model and operation order used by this lesson.",
  ...
  "visualizerCaption": "A call stack walkthrough for Static Variable In Recursion.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values Static Variable In Recursion needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that Static Variable In Recursion needs to inspect or change.",
      "activeLine": 1,
