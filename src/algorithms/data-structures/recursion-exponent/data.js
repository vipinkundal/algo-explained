...
export const algorithmPage = {
  ...
  "meaning": "Recursion Exponent shows how data is organized, changed, and inspected through a small browser demo with the original C/C++ reference available beside it.",
  ...
  "visualizerCaption": "A call stack walkthrough for Recursion Exponent.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values Recursion Exponent needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that Recursion Exponent needs to inspect or change.",
      "activeLine": 1,
