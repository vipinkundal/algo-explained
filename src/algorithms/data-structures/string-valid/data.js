...
export const algorithmPage = {
  ...
  "sourceFile": "04_valid.cpp",
  "sourceLanguage": "cpp",
  "route": "/algorithms/data-structures/string-valid",
  "phase": 1,
  "priority": "medium",
  "visualizerType": "string-scan",
  "icon": "abc",
  "codePath": "./src/algorithms/data-structures/string-valid/code/solution.js",
  "codeFilename": "solution.js",
  "originalCodePath": "./src/algorithms/data-structures/string-valid/code/original.cpp",
  "originalCodeFilename": "04_valid.cpp",
  "originalActiveLine": 2,
  "meaning": "String Valid shows how data is organized, changed, and inspected through a small browser demo with a C/C++ reference available beside it.",
  "problem": "String Valid explains the string state model and how one focused change updates it.",
  ...
  "realLifeExample": "String Valid is useful when you need to understand the mechanics behind library-level data structures.",
  "whenToUse": "Use this page when learning Strings behavior through state changes instead of memorized code.",
  "memoryTrick": "String Valid: name the invariant, then trace the exact state change.",
  "visualizerCaption": "String Valid is shown as character-state updates. The numbered steps follow the code path used to maintain the main invariant.",
  "logicSteps": [
    {
      "title": "Read text",
  ...
  "variables": [
    ...
    {
      "name": "character bag",
      "purpose": "Tracks characters considered by String Valid."
    },
    {
      "name": "text result",
  ...
  "dryRun": [
    ...
    },
    {
      ...
      "activeLine": 6,
      "codeInsight": "Executes this String Valid line as part of the highlighted code path, linking the visual step to the implementation."
    },
    {
      "label": "Result",
      ...
      "activeLine": 5,
      "codeInsight": "Returns { structure: \"string\", input: text, reversed, length: text.length }, the value produced after String Valid's state changes are complete."
    }
  ],
  "complexity": {
  ...
  "quiz": {
    "question": "What should you identify first when studying String Valid?",
    "options": [
      {
        "key": "A",
  ...
  "algorithmSlug": "string-valid",
  "animation": {
    "type": "string-flow",
    "title": "String Valid character scan",
    ...
    "steps": [
      {
        ...
        "title": "Read string input",
        "note": "The code receives text, pattern, or character data.",
        "ruleLabel": "String Valid invariant",
      ...
      },
      {
        ...
        "note": "One character changes the active string state.",
        "ruleLabel": "String Valid invariant",
        "rule": "Executes this String Valid line as part of the highlighted code path, linking the visual step to the implementation.",
        "activeRange": [
          2,
          4
        ],
      ...
      },
      {
        ...
        "note": "Matches or best values are returned after the scan.",
        "ruleLabel": "String Valid invariant",
        "rule": "Returns { structure: \"string\", input: text, reversed, length: text.length }, the value produced after String Valid's state changes are complete.",
        "activeRange": [
          3,
          5
        ],
