...
export const algorithmPage = {
  ...
  "visualizerCaption": "A string scan walkthrough for String Valid.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values String Valid needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that String Valid needs to inspect or change.",
      "activeLine": 1,
