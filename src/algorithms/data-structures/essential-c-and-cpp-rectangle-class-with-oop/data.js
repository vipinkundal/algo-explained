...
export const algorithmPage = {
  ...
  "meaning": "C/C++ Rectangle Class With Oop shows how data is organized, changed, and inspected through a small browser demo with the original C/C++ reference available beside it.",
  ...
  "visualizerCaption": "A cpp memory model walkthrough for C/C++ Rectangle Class With Oop.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values C/C++ Rectangle Class With Oop needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that C/C++ Rectangle Class With Oop needs to inspect or change.",
      "activeLine": 1,
