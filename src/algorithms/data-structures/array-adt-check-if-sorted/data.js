...
export const algorithmPage = {
  ...
  "meaning": "Check Sorted Array shows how data is organized, changed, and inspected through a small browser demo with the original C/C++ reference available beside it.",
  ...
  "visualizerCaption": "An array adt walkthrough for Check Sorted Array.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values Check Sorted Array needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that Check Sorted Array needs to inspect or change.",
      "activeLine": 1,
