...
export const algorithmPage = {
  ...
  "meaning": "Circular Queue shows how data is organized, changed, and inspected through a small browser demo with the original C/C++ reference available beside it.",
  ...
  "visualizerCaption": "A queue operations walkthrough for Circular Queue.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values Circular Queue needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that Circular Queue needs to inspect or change.",
      "activeLine": 1,
