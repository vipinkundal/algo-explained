    ...
    "steps": [
      {
        ...
        "rule": "Defines essentialCAndCppModularWithStructureProgrammingStyle as the runnable entry point for this lesson.",
        "activeState": 0
      },
      {
        "phase": "Storage",
        ...
        "note": "Passing by value, pointer, or reference controls what can change.",
        "ruleLabel": "C/C++ Modular With Structure Programming Style invariant",
        "rule": "Sets the returned topic field to \"C/C++ Modular With Structure Programming Style\", which is one of the named values rendered in the visual summary.",
        "activeState": 1
      },
      {
        "phase": "C/C++ rule",
