...
export const algorithmPage = {
  ...
  "meaning": "C/C++ Modular With Structure Programming Style shows how data is organized, changed, and inspected through a small browser demo with the original C/C++ reference available beside it.",
  ...
  "originalCodeInsight": "The original C/C++ Modular With Structure Programming Style source shows the C/C++ memory model and operation order used by this lesson.",
  ...
  "visualizerCaption": "A cpp memory model walkthrough for C/C++ Modular With Structure Programming Style.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values C/C++ Modular With Structure Programming Style needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that C/C++ Modular With Structure Programming Style needs to inspect or change.",
      "activeLine": 1,
