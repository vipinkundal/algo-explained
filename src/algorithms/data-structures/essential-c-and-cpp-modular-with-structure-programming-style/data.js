...
export const algorithmPage = {
  "id": "ds-essential-c-and-cpp-modular-with-structure-programming-style",
  "title": "C/C++ Modular With Structure Programming Style",
  "category": "Data Structures",
  "track": "Data Structures",
  "topicGroup": "C/C++ Essentials",
  "sourceFolder": "01_Essential_c_and_cpp",
  "sourceFile": "09_02_modeular_with_structure_programming_style.cpp",
  "sourceLanguage": "cpp",
  "route": "/algorithms/data-structures/essential-c-and-cpp-modular-with-structure-programming-style",
  "phase": 1,
  "priority": "medium",
  "visualizerType": "cpp-memory-model",
  "icon": "data_object",
  "codePath": "./src/algorithms/data-structures/essential-c-and-cpp-modular-with-structure-programming-style/code/solution.js",
  ...
  "dryRun": [
    {
      ...
      "activeLine": 1,
      "codeInsight": "Executes this C/C++ Modular With Structure Programming Style line as part of the highlighted code path, linking the visual step to the implementation."
    },
    {
      "label": "Storage",
    ...
    },
    {
      ...
      "activeLine": 3,
      "codeInsight": "Returns {, the value produced after C/C++ Modular With Structure Programming Style's state changes are complete."
    }
  ],
  "complexity": {
  ...
  "quiz": {
    "question": "What should you identify first when studying C/C++ Modular With Structure Programming Style?",
    "options": [
      {
        "key": "A",
  ...
  "algorithmSlug": "essential-c-and-cpp-modular-with-structure-programming-style",
  "animation": {
    "type": "state-flow",
    "title": "C/C++ Modular With Structure Programming Style state transitions",
    ...
    "steps": [
      {
        ...
        "title": "Create program value",
        "note": "The code introduces the variable, pointer, structure, or object.",
        "ruleLabel": "C/C++ Modular With Structure Programming Style invariant",
        "rule": "Executes this C/C++ Modular With Structure Programming Style line as part of the highlighted code path, linking the visual step to the implementation.",
        "activeState": 0
      },
      {
        "phase": "Storage",
      ...
      },
      {
        ...
        "note": "The visible output follows from the memory model.",
        "ruleLabel": "C/C++ Modular With Structure Programming Style invariant",
        "rule": "Returns {, the value produced after C/C++ Modular With Structure Programming Style's state changes are complete.",
        "activeState": 3
      }
    ]
  }
