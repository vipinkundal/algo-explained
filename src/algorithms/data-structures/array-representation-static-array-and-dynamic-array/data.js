...
export const algorithmPage = {
  ...
  "meaning": "Static Array And Dynamic Array shows how data is organized, changed, and inspected through a small browser demo with a C/C++ reference available beside it.",
  "problem": "Static Array And Dynamic Array explains the array state model and how one focused change updates it.",
  "concept": "Static Array And Dynamic Array is useful when contiguous storage, indexes, length, or capacity explain the operation. Use this when an array operation depends on slot position, bounds, or shifting values.",
  ...
  "realLifeExample": "Static Array And Dynamic Array is useful when you need to understand the mechanics behind library-level data structures.",
  "whenToUse": "Use this page when learning Arrays / Array ADT behavior through state changes instead of memorized code.",
  "memoryTrick": "Static Array And Dynamic Array: name the invariant, then trace the exact state change.",
  "visualizerCaption": "Static Array And Dynamic Array is shown as indexed array state changes. The numbered steps follow the code path used to maintain the main invariant.",
  "logicSteps": [
    {
      "title": "Read request",
  ...
  "variables": [
    ...
    {
      "name": "array view",
      "purpose": "Shows the slots after Static Array And Dynamic Array applies its operation."
    }
  ],
  "dryRun": [
    {
    ...
    },
    {
      ...
      "activeLine": 6,
      "codeInsight": "Executes this Static Array And Dynamic Array line as part of the highlighted code path, linking the visual step to the implementation."
    },
    {
      "label": "Result",
      ...
      "activeLine": 5,
      "codeInsight": "Returns { structure: \"array\", values, length: values.length, max: Math.max(...values), sum }, the value produced after Static Array And Dynamic Array's state changes are complete."
    }
  ],
  "complexity": {
  ...
  "animation": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "note": "The operation sets, shifts, scans, or resizes array slots.",
        "ruleLabel": "Static Array And Dynamic Array invariant",
        "rule": "Executes this Static Array And Dynamic Array line as part of the highlighted code path, linking the visual step to the implementation.",
        "activeIndices": [
          2
        ],
        "sortedIndices": [],
      ...
      },
      {
        ...
        "note": "The visible value or updated array confirms the operation.",
        "ruleLabel": "Static Array And Dynamic Array invariant",
        "rule": "Returns { structure: \"array\", values, length: values.length, max: Math.max(...values), sum }, the value produced after Static Array And Dynamic Array's state changes are complete.",
        "activeIndices": [
          3,
          4
        ],
