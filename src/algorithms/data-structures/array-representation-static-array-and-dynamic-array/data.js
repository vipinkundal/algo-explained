...
export const algorithmPage = {
  ...
  "visualizerCaption": "An array memory walkthrough for Static Array And Dynamic Array.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values Static Array And Dynamic Array needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that Static Array And Dynamic Array needs to inspect or change.",
      "activeLine": 1,
