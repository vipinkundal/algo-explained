...
export const algorithmPage = {
  ...
  "visualizerCaption": "A call stack walkthrough for Indirect Recursion.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values Indirect Recursion needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that Indirect Recursion needs to inspect or change.",
      "activeLine": 1,
