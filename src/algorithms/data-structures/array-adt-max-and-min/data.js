...
export const algorithmPage = {
  ...
  "visualizerCaption": "An array adt walkthrough for Array ADT Max And Min.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values Array ADT Max And Min needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that Array ADT Max And Min needs to inspect or change.",
      "activeLine": 1,
