...
export const algorithmPage = {
  ...
  "meaning": "Recursion Tower of Hanoi shows how data is organized, changed, and inspected through a small browser demo with a C/C++ reference available beside it.",
  "problem": "Recursion Tower of Hanoi explains the recursive call state model and how one focused change updates it.",
  "concept": "Recursion Tower of Hanoi is useful when stack behavior is the clearest model for the data changes. Use this when the problem is naturally described by last-in, first-out state.",
  ...
  "realLifeExample": "Recursion Tower of Hanoi is useful when you need to understand the mechanics behind library-level data structures.",
  "whenToUse": "Use this page when learning Recursion behavior through state changes instead of memorized code.",
  "memoryTrick": "Recursion Tower of Hanoi: name the invariant, then trace the exact state change.",
  "visualizerCaption": "Recursion Tower of Hanoi is shown as stack state changes. The numbered steps follow the code path used to maintain the main invariant.",
  "logicSteps": [
    {
      "title": "Read stack",
  ...
  "variables": [
    ...
    {
      "name": "final value",
      "purpose": "The answer produced by Recursion Tower of Hanoi."
    }
  ],
  "dryRun": [
    {
    ...
    },
    {
      ...
      "activeLine": 6,
      "codeInsight": "Returns value <= 1 ? 1 : value * factorial(value - 1), the value produced after Recursion Tower of Hanoi's state changes are complete."
    }
  ],
  "complexity": {
  ...
  "animation": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "note": "The return value or printed state confirms the operation.",
        "ruleLabel": "Recursion Tower of Hanoi invariant",
        "rule": "Returns value <= 1 ? 1 : value * factorial(value - 1), the value produced after Recursion Tower of Hanoi's state changes are complete.",
        "activeCall": 3,
        "returningCalls": [
          0,
          1,
