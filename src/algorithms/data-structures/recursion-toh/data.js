...
export const algorithmPage = {
  ...
  "visualizerCaption": "A call stack walkthrough for Recursion Tower of Hanoi.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values Recursion Tower of Hanoi needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that Recursion Tower of Hanoi needs to inspect or change.",
      "activeLine": 1,
