...
export const algorithmPage = {
  ...
  "meaning": "C/C++ Reference shows how data is organized, changed, and inspected through a small browser demo with a C/C++ reference available beside it.",
  "problem": "C/C++ Reference explains the C/C++ storage state model and how one focused change updates it.",
  "concept": "C/C++ Reference is useful when C/C++ storage, addresses, structures, or object ownership affect the program result. Use this when the lesson depends on stack memory, heap memory, references, pointers, structs, or classes.",
  ...
  "realLifeExample": "C/C++ Reference is useful when you need to understand the mechanics behind library-level data structures.",
  "whenToUse": "Use this page when learning C/C++ Essentials behavior through state changes instead of memorized code.",
  "memoryTrick": "C/C++ Reference: name the invariant, then trace the exact state change.",
  "visualizerCaption": "C/C++ Reference is shown as C/C++ memory and value flow. The numbered steps follow the code path used to maintain the main invariant.",
  "logicSteps": [
    {
      "title": "Declare value",
  ...
  "variables": [
    ...
    {
      "name": "printed output",
      "purpose": "The observable result produced by C/C++ Reference."
    }
  ],
  "dryRun": [
    {
      ...
      "activeLine": 1,
      "codeInsight": "Executes this C/C++ Reference line as part of the highlighted code path, linking the visual step to the implementation."
    },
    {
      "label": "Storage",
    ...
    },
    {
      ...
      "activeLine": 3,
      "codeInsight": "Returns {, the value produced after C/C++ Reference's state changes are complete."
    }
  ],
  "complexity": {
    ...
    "steps": [
      {
        ...
        "rule": "Executes this C/C++ Reference line as part of the highlighted code path, linking the visual step to the implementation.",
        "activeState": 0
      },
      {
        "phase": "Storage",
      ...
      },
      {
        ...
        "note": "The visible output follows from the memory model.",
        "ruleLabel": "C/C++ Reference invariant",
        "rule": "Returns {, the value produced after C/C++ Reference's state changes are complete.",
        "activeState": 3
      }
    ]
  }
