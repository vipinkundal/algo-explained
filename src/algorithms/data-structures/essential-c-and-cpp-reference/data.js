...
export const algorithmPage = {
  ...
  "visualizerCaption": "A cpp memory model walkthrough for C/C++ Reference.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values C/C++ Reference needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that C/C++ Reference needs to inspect or change.",
      "activeLine": 1,
