...
export const algorithmPage = {
  ...
  "visualizerCaption": "A cpp memory model walkthrough for C/C++ Oop Style.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values C/C++ Oop Style needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that C/C++ Oop Style needs to inspect or change.",
      "activeLine": 1,
