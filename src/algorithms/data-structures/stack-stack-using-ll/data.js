...
export const algorithmPage = {
  ...
  "visualizerCaption": "A stack operations walkthrough for Stack Using Linked List.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values Stack Using Linked List needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that Stack Using Linked List needs to inspect or change.",
      "activeLine": 1,
