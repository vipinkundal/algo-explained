...
export const algorithmPage = {
  ...
  "meaning": "Binary Tree Stack shows how data is organized, changed, and inspected through a small browser demo with the original C/C++ reference available beside it.",
  ...
  "visualizerCaption": "A tree structure walkthrough for Binary Tree Stack.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values Binary Tree Stack needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that Binary Tree Stack needs to inspect or change.",
      "activeLine": 1,
