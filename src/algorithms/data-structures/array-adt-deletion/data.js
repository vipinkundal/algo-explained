  ...
  "dryRun": [
    {
      ...
      "activeLine": 2,
      "codeInsight": "Defines arrayAdtDeletion as the runnable entry point for this lesson."
    },
    {
      "label": "Index / length",
    ...
    "steps": [
      {
        ...
        "rule": "Defines arrayAdtDeletion as the runnable entry point for this lesson.",
        "activeIndices": [
          0
        ],
        "sortedIndices": [],
