...
export const algorithmPage = {
  ...
  "meaning": "Deletion in Array ADT shows how data is organized, changed, and inspected through a small browser demo with the original C/C++ reference available beside it.",
  ...
  "visualizerCaption": "An array adt walkthrough for Deletion in Array ADT.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values Deletion in Array ADT needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that Deletion in Array ADT needs to inspect or change.",
      "activeLine": 1,
