...
export const algorithmPage = {
  ...
  "dryRun": [
    ...
    },
    {
      ...
      "activeLine": 5,
      "codeInsight": "Returns { structure: \"linked list\", operation: \"insert at position 1\", values: nodes.map((node) => node.value) }, the value produced after Linked List Deletion's state changes are complete."
    },
    {
      "label": "Result",
  ...
  "animation": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "note": "Only the necessary linked list fields are changed.",
        "ruleLabel": "Linked List Deletion invariant",
        "rule": "Returns { structure: \"linked list\", operation: \"insert at position 1\", values: nodes.map((node) => node.value) }, the value produced after Linked List Deletion's state changes are complete.",
        "activeNode": "n3",
        "previousNode": "n2",
        "nextNode": "tail"
      },
