...
export const algorithmPage = {
  ...
  "meaning": "Linked List Deletion shows how data is organized, changed, and inspected through a small browser demo with the original C/C++ reference available beside it.",
  ...
  "visualizerCaption": "A linked list walkthrough for Linked List Deletion.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values Linked List Deletion needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that Linked List Deletion needs to inspect or change.",
      "activeLine": 1,
