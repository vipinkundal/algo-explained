...
export const algorithmPage = {
  ...
  "meaning": "Linked List Isloop shows how data is organized, changed, and inspected through a small browser demo with the original C/C++ reference available beside it.",
  ...
  "visualizerCaption": "A linked list walkthrough for Linked List Isloop.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values Linked List Isloop needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that Linked List Isloop needs to inspect or change.",
      "activeLine": 1,
