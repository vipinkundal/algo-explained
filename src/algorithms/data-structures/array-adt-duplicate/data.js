...
export const algorithmPage = {
  ...
  "visualizerCaption": "An array adt walkthrough for Array ADT Duplicate.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values Array ADT Duplicate needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that Array ADT Duplicate needs to inspect or change.",
      "activeLine": 1,
