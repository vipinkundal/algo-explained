...
export const algorithmPage = {
  ...
  "dryRun": [
    ...
    },
    {
      ...
      "activeLine": 6,
      "codeInsight": "Executes this Array ADT Inserting In Sorted Array line as part of the highlighted code path, linking the visual step to the implementation."
    },
    {
      "label": "Sorted output",
      ...
      "activeLine": 5,
      "codeInsight": "Returns { structure: \"array\", values, length: values.length, max: Math.max(...values), sum }, the value produced after Array ADT Inserting In Sorted Array's state changes are complete."
    }
  ],
  "complexity": {
  ...
  "animation": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "note": "The current operation reduces disorder.",
        "ruleLabel": "Array ADT Inserting In Sorted Array invariant",
        "rule": "Executes this Array ADT Inserting In Sorted Array line as part of the highlighted code path, linking the visual step to the implementation.",
        "activeIndices": [
          2
        ],
        "sortedIndices": [],
      ...
      },
      {
        ...
        "note": "The result is returned when no unsorted work remains.",
        "ruleLabel": "Array ADT Inserting In Sorted Array invariant",
        "rule": "Returns { structure: \"array\", values, length: values.length, max: Math.max(...values), sum }, the value produced after Array ADT Inserting In Sorted Array's state changes are complete.",
        "activeIndices": [
          3,
          4
        ],
