...
export const algorithmPage = {
  ...
  "visualizerCaption": "A call stack walkthrough for Nested Recursion.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values Nested Recursion needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that Nested Recursion needs to inspect or change.",
      "activeLine": 1,
