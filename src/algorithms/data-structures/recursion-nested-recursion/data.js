...
export const algorithmPage = {
  ...
  "meaning": "Nested Recursion shows how data is organized, changed, and inspected through a small browser demo with a C/C++ reference available beside it.",
  "problem": "Nested Recursion explains the recursive call state model and how one focused change updates it.",
  "concept": "Nested Recursion is useful when stack behavior is the clearest model for the data changes. Use this when the problem is naturally described by last-in, first-out state.",
  ...
  "realLifeExample": "Nested Recursion is useful when you need to understand the mechanics behind library-level data structures.",
  "whenToUse": "Use this page when learning Recursion behavior through state changes instead of memorized code.",
  "memoryTrick": "Nested Recursion: name the invariant, then trace the exact state change.",
  "visualizerCaption": "Nested Recursion is shown as stack state changes. The numbered steps follow the code path used to maintain the main invariant.",
  "logicSteps": [
    {
      "title": "Read stack",
  ...
  "variables": [
    ...
    {
      "name": "final value",
      "purpose": "The answer produced by Nested Recursion."
    }
  ],
  "dryRun": [
    {
      ...
      "activeLine": 2,
      "codeInsight": "Defines recursionNestedRecursion and names the input n = 5; edits to those inputs change the visual state and output."
    },
    {
      "label": "Stack top",
      "title": "Inspect stack",
    ...
    },
    {
      ...
      "activeLine": 6,
      "codeInsight": "Returns value <= 1 ? 1 : value * factorial(value - 1), the final value maintained by Nested Recursion's code path."
    }
  ],
  "complexity": {
