...
export const algorithmPage = {
  ...
  "visualizerCaption": "A sparse matrix walkthrough for Sparse Matrix Using C++.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values Sparse Matrix Using C++ needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that Sparse Matrix Using C++ needs to inspect or change.",
      "activeLine": 1,
