...
export const algorithmPage = {
  ...
  "meaning": "String shows how data is organized, changed, and inspected through a small browser demo with the original C/C++ reference available beside it.",
  ...
  "originalCodeInsight": "The original String source shows the C/C++ memory model and operation order used by this lesson.",
  ...
  "visualizerCaption": "A string scan walkthrough for String.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values String needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that String needs to inspect or change.",
      "activeLine": 1,
