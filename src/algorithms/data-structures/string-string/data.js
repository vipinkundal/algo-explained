...
export const algorithmPage = {
  ...
  "dryRun": [
    ...
    },
    {
      ...
      "activeLine": 6,
      "codeInsight": "Executes this String line as part of the highlighted code path, linking the visual step to the implementation."
    },
    {
      "label": "Result",
      ...
      "activeLine": 5,
      "codeInsight": "Returns { structure: \"string\", input: text, reversed, length: text.length }, the value produced after String's state changes are complete."
    }
  ],
  "complexity": {
  ...
  "animation": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "note": "One character changes the active string state.",
        "ruleLabel": "String invariant",
        "rule": "Executes this String line as part of the highlighted code path, linking the visual step to the implementation.",
        "activeRange": [
          2,
          4
        ],
      ...
      },
      {
        ...
        "note": "Matches or best values are returned after the scan.",
        "ruleLabel": "String invariant",
        "rule": "Returns { structure: \"string\", input: text, reversed, length: text.length }, the value produced after String's state changes are complete.",
        "activeRange": [
          3,
          5
        ],
