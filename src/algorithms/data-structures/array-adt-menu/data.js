...
export const algorithmPage = {
  ...
  "visualizerCaption": "An array adt walkthrough for Array ADT Menu.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values Array ADT Menu needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that Array ADT Menu needs to inspect or change.",
      "activeLine": 1,
