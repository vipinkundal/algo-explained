...
export const algorithmPage = {
  ...
  "meaning": "Creation And Display Of Sparse Matrix shows how data is organized, changed, and inspected through a small browser demo with the original C/C++ reference available beside it.",
  ...
  "visualizerCaption": "A sparse matrix walkthrough for Creation And Display Of Sparse Matrix.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values Creation And Display Of Sparse Matrix needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that Creation And Display Of Sparse Matrix needs to inspect or change.",
      "activeLine": 1,
