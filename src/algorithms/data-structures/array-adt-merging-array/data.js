...
export const algorithmPage = {
  ...
  "meaning": "Array ADT Merging Array shows how data is organized, changed, and inspected through a small browser demo with a C/C++ reference available beside it.",
  ...
  "dryRun": [
    {
      ...
      "activeLine": 2,
      "codeInsight": "Defines arrayAdtMergingArray as the runnable entry point for this lesson."
    },
    {
      "label": "Index / length",
  ...
  "animation": {
    "type": "array-flow",
    "title": "Array ADT Merging Array array state",
    ...
    "steps": [
      {
        ...
        "rule": "Defines arrayAdtMergingArray as the runnable entry point for this lesson.",
        "activeIndices": [
          0
        ],
        "sortedIndices": [],
