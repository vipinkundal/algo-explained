...
export const algorithmPage = {
  ...
  "visualizerCaption": "An array adt walkthrough for Array ADT Merging Array.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values Array ADT Merging Array needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that Array ADT Merging Array needs to inspect or change.",
      "activeLine": 1,
