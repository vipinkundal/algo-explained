...
export const algorithmPage = {
  ...
  "meaning": "Reverse String shows how data is organized, changed, and inspected through a small browser demo with a C/C++ reference available beside it.",
  "problem": "Reverse String explains the string state model and how one focused change updates it.",
  ...
  "realLifeExample": "Reverse String is useful when you need to understand the mechanics behind library-level data structures.",
  "whenToUse": "Use this page when learning Strings behavior through state changes instead of memorized code.",
  "memoryTrick": "Reverse String: name the invariant, then trace the exact state change.",
  "visualizerCaption": "Reverse String is shown as character-state updates. The numbered steps follow the code path used to maintain the main invariant.",
  "logicSteps": [
    {
      "title": "Read text",
  ...
  "variables": [
    ...
    {
      "name": "character bag",
      "purpose": "Tracks characters considered by Reverse String."
    },
    {
      "name": "text result",
  ...
  "dryRun": [
    ...
    },
    {
      ...
      "activeLine": 6,
      "codeInsight": "Executes this Reverse String line as part of the highlighted code path, linking the visual step to the implementation."
    },
    {
      "label": "Result",
      ...
      "activeLine": 5,
      "codeInsight": "Returns { structure: \"string\", input: text, reversed, length: text.length }, the value produced after Reverse String's state changes are complete."
    }
  ],
  "complexity": {
  ...
  "animation": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "note": "One character changes the active string state.",
        "ruleLabel": "Reverse String invariant",
        "rule": "Executes this Reverse String line as part of the highlighted code path, linking the visual step to the implementation.",
        "activeRange": [
          2,
          4
        ],
      ...
      },
      {
        ...
        "note": "Matches or best values are returned after the scan.",
        "ruleLabel": "Reverse String invariant",
        "rule": "Returns { structure: \"string\", input: text, reversed, length: text.length }, the value produced after Reverse String's state changes are complete.",
        "activeRange": [
          3,
          5
        ],
