...
export const algorithmPage = {
  ...
  "visualizerCaption": "A string scan walkthrough for Reverse String.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values Reverse String needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that Reverse String needs to inspect or change.",
      "activeLine": 1,
