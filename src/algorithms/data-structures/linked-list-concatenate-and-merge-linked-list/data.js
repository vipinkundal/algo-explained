...
export const algorithmPage = {
  ...
  "meaning": "Concatenate And Merge Linked List shows how data is organized, changed, and inspected through a small browser demo with the original C/C++ reference available beside it.",
  ...
  "visualizerCaption": "A linked list walkthrough for Concatenate And Merge Linked List.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values Concatenate And Merge Linked List needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that Concatenate And Merge Linked List needs to inspect or change.",
      "activeLine": 1,
