...
export const algorithmPage = {
  ...
  "meaning": "C/C++ Above Program As Template Class shows how data is organized, changed, and inspected through a small browser demo with a C/C++ reference available beside it.",
  "problem": "C/C++ Above Program As Template Class explains the C/C++ storage state model and how one focused change updates it.",
  "concept": "C/C++ Above Program As Template Class is useful when C/C++ storage, addresses, structures, or object ownership affect the program result. Use this when the lesson depends on stack memory, heap memory, references, pointers, structs, or classes.",
  ...
  "realLifeExample": "C/C++ Above Program As Template Class is useful when you need to understand the mechanics behind library-level data structures.",
  "whenToUse": "Use this page when learning C/C++ Essentials behavior through state changes instead of memorized code.",
  "memoryTrick": "C/C++ Above Program As Template Class: name the invariant, then trace the exact state change.",
  "visualizerCaption": "C/C++ Above Program As Template Class is shown as C/C++ memory and value flow. The numbered steps follow the code path used to maintain the main invariant.",
  "logicSteps": [
    {
      "title": "Declare value",
  ...
  "variables": [
    ...
    {
      "name": "printed output",
      "purpose": "The observable result produced by C/C++ Above Program As Template Class."
    }
  ],
  "dryRun": [
    {
      ...
      "activeLine": 1,
      "codeInsight": "Executes this C/C++ Above Program As Template Class line as part of the highlighted code path, linking the visual step to the implementation."
    },
    {
      "label": "Storage",
    ...
    },
    {
      ...
      "activeLine": 3,
      "codeInsight": "Returns {, the value produced after C/C++ Above Program As Template Class's state changes are complete."
    }
  ],
  "complexity": {
    ...
    "steps": [
      {
        ...
        "rule": "Executes this C/C++ Above Program As Template Class line as part of the highlighted code path, linking the visual step to the implementation.",
        "activeState": 0
      },
      {
        "phase": "Storage",
      ...
      },
      {
        ...
        "note": "The visible output follows from the memory model.",
        "ruleLabel": "C/C++ Above Program As Template Class invariant",
        "rule": "Returns {, the value produced after C/C++ Above Program As Template Class's state changes are complete.",
        "activeState": 3
      }
    ]
  }
