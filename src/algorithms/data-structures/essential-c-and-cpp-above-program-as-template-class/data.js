...
export const algorithmPage = {
  ...
  "visualizerCaption": "A cpp memory model walkthrough for C/C++ Above Program As Template Class.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values C/C++ Above Program As Template Class needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that C/C++ Above Program As Template Class needs to inspect or change.",
      "activeLine": 1,
