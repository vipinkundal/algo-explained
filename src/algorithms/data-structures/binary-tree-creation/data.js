...
export const algorithmPage = {
  ...
  "visualizerCaption": "A tree structure walkthrough for Binary Tree Creation.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values Binary Tree Creation needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that Binary Tree Creation needs to inspect or change.",
      "activeLine": 1,
