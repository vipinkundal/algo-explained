...
export const algorithmPage = {
  ...
  "visualizerCaption": "A call stack walkthrough for Recursion Fibonacci.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values Recursion Fibonacci needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that Recursion Fibonacci needs to inspect or change.",
      "activeLine": 1,
