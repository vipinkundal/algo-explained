...
export const algorithmPage = {
  ...
  "visualizerCaption": "A string scan walkthrough for String Vowels No Of Words.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values String Vowels No Of Words needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that String Vowels No Of Words needs to inspect or change.",
      "activeLine": 1,
