...
export const algorithmPage = {
  ...
  "meaning": "Infix to Postfix Conversion shows how data is organized, changed, and inspected through a small browser demo with the original C/C++ reference available beside it.",
  ...
  "visualizerCaption": "A stack operations walkthrough for Infix to Postfix Conversion.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values Infix to Postfix Conversion needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that Infix to Postfix Conversion needs to inspect or change.",
      "activeLine": 1,
