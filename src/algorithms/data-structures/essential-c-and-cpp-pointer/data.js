...
export const algorithmPage = {
  ...
  "meaning": "C/C++ Pointer shows how data is organized, changed, and inspected through a small browser demo with a C/C++ reference available beside it.",
  "problem": "C/C++ Pointer explains the C/C++ storage state model and how one focused change updates it.",
  "concept": "C/C++ Pointer is useful when C/C++ storage, addresses, structures, or object ownership affect the program result. Use this when the lesson depends on stack memory, heap memory, references, pointers, structs, or classes.",
  ...
  "realLifeExample": "C/C++ Pointer is useful when you need to understand the mechanics behind library-level data structures.",
  "whenToUse": "Use this page when learning C/C++ Essentials behavior through state changes instead of memorized code.",
  "memoryTrick": "C/C++ Pointer: name the invariant, then trace the exact state change.",
  "visualizerCaption": "C/C++ Pointer is shown as C/C++ memory and value flow. The numbered steps follow the code path used to maintain the main invariant.",
  "logicSteps": [
    {
      "title": "Declare value",
  ...
  "variables": [
    ...
    {
      "name": "printed output",
      "purpose": "The observable result produced by C/C++ Pointer."
    }
  ],
  "dryRun": [
    {
      ...
      "activeLine": 2,
      "codeInsight": "Defines essentialCAndCppPointer as the runnable entry point for this lesson."
    },
    {
      "label": "Storage",
      ...
      "activeLine": 4,
      "codeInsight": "Sets the returned topic field to \"C/C++ Pointer\", which is one of the named values rendered in the visual summary."
    },
    {
      "label": "C/C++ rule",
