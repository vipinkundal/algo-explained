...
export const algorithmPage = {
  ...
  "visualizerCaption": "A cpp memory model walkthrough for C/C++ Pointer.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values C/C++ Pointer needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that C/C++ Pointer needs to inspect or change.",
      "activeLine": 1,
