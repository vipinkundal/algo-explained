...
export const algorithmPage = {
  ...
  "meaning": "Array ADT Set shows how data is organized, changed, and inspected through a small browser demo with the original C/C++ reference available beside it.",
  ...
  "visualizerCaption": "An array adt walkthrough for Array ADT Set.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values Array ADT Set needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that Array ADT Set needs to inspect or change.",
      "activeLine": 1,
