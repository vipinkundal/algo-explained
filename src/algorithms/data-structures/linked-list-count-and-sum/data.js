...
export const algorithmPage = {
  ...
  "visualizerCaption": "A linked list walkthrough for Linked List Count And Sum.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values Linked List Count And Sum needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that Linked List Count And Sum needs to inspect or change.",
      "activeLine": 1,
