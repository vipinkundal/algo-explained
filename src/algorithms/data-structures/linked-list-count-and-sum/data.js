...
export const algorithmPage = {
  ...
  "meaning": "Linked List Count And Sum shows how data is organized, changed, and inspected through a small browser demo with a C/C++ reference available beside it.",
  ...
  "dryRun": [
    ...
    },
    {
      ...
      "activeLine": 5,
      "codeInsight": "Returns { structure: \"linked list\", operation: \"insert at position 1\", values: nodes.map((node) => node.value) }, the value produced after Linked List Count And Sum's state changes are complete."
    },
    {
      "label": "Result",
  ...
  "animation": {
    ...
    "title": "Linked List Count And Sum pointer state",
    ...
    "steps": [
      {
        ...
        "title": "Read linked list action",
        "note": "The code receives the next value or command.",
        "ruleLabel": "Linked List Count And Sum invariant",
      ...
      },
      {
        ...
        "note": "Only the necessary linked list fields are changed.",
        "ruleLabel": "Linked List Count And Sum invariant",
        "rule": "Returns { structure: \"linked list\", operation: \"insert at position 1\", values: nodes.map((node) => node.value) }, the value produced after Linked List Count And Sum's state changes are complete.",
        "activeNode": "n3",
        "previousNode": "n2",
        "nextNode": "tail"
      },
