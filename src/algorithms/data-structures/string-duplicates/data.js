...
export const algorithmPage = {
  ...
  "meaning": "String Duplicates shows how data is organized, changed, and inspected through a small browser demo with a C/C++ reference available beside it.",
  ...
  "memoryTrick": "String Duplicates: name the invariant, then trace the exact state change.",
  "visualizerCaption": "String Duplicates is shown as character-state updates. The numbered steps follow the code path used to maintain the main invariant.",
  "logicSteps": [
    {
      "title": "Read text",
  ...
  "animation": {
    "type": "string-flow",
    "title": "String Duplicates character scan",
