...
export const algorithmPage = {
  ...
  "visualizerCaption": "An array adt walkthrough for Array ADT Negative Values.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values Array ADT Negative Values needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that Array ADT Negative Values needs to inspect or change.",
      "activeLine": 1,
