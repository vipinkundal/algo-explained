...
export const algorithmPage = {
  ...
  "visualizerCaption": "A linked list walkthrough for Max Linked List.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values Max Linked List needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that Max Linked List needs to inspect or change.",
      "activeLine": 1,
