...
export const algorithmPage = {
  ...
  "meaning": "Max Linked List shows how data is organized, changed, and inspected through a small browser demo with a C/C++ reference available beside it.",
  "problem": "Max Linked List explains the linked-list state model and how one focused change updates it.",
  "concept": "Max Linked List is useful when linked list behavior is the clearest model for the data changes. Use this when the problem is naturally described by node-link structure.",
  ...
  "realLifeExample": "Max Linked List is useful when you need to understand the mechanics behind library-level data structures.",
  "whenToUse": "Use this page when learning Linked List behavior through state changes instead of memorized code.",
  "memoryTrick": "Max Linked List: name the invariant, then trace the exact state change.",
  "visualizerCaption": "Max Linked List is shown as linked list state changes. The numbered steps follow the code path used to maintain the main invariant.",
  "logicSteps": [
    {
  ...
  "variables": [
    ...
    {
      "name": "new node",
      "purpose": "Represents the node created or examined in Max Linked List."
    },
    {
      "name": "chain view",
  ...
  "dryRun": [
    ...
    },
    {
      ...
      "activeLine": 5,
      "codeInsight": "Returns { structure: \"linked list\", operation: \"insert at position 1\", values: nodes.map((node) => node.value) }, the value produced after Max Linked List's state changes are complete."
    },
    {
      "label": "Result",
  ...
  "animation": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "note": "Only the necessary linked list fields are changed.",
        "ruleLabel": "Max Linked List invariant",
        "rule": "Returns { structure: \"linked list\", operation: \"insert at position 1\", values: nodes.map((node) => node.value) }, the value produced after Max Linked List's state changes are complete.",
        "activeNode": "n3",
        "previousNode": "n2",
        "nextNode": "tail"
      },
