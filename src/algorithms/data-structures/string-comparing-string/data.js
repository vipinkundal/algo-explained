...
export const algorithmPage = {
  ...
  "meaning": "Comparing String shows how data is organized, changed, and inspected through a small browser demo with the original C/C++ reference available beside it.",
  ...
  "visualizerCaption": "A string scan walkthrough for Comparing String.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values Comparing String needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that Comparing String needs to inspect or change.",
      "activeLine": 1,
