...
export const algorithmPage = {
  ...
  "meaning": "C/C++ Structure shows how data is organized, changed, and inspected through a small browser demo with a C/C++ reference available beside it.",
  "problem": "C/C++ Structure explains the C/C++ storage state model and how one focused change updates it.",
  "concept": "C/C++ Structure is useful when C/C++ storage, addresses, structures, or object ownership affect the program result. Use this when the lesson depends on stack memory, heap memory, references, pointers, structs, or classes.",
  ...
  "memoryTrick": "C/C++ Structure: name the invariant, then trace the exact state change.",
  "visualizerCaption": "C/C++ Structure is shown as C/C++ memory and value flow. The numbered steps follow the code path used to maintain the main invariant.",
  "logicSteps": [
    {
      "title": "Declare value",
