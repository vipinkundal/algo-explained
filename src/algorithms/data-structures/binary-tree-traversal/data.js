...
export const algorithmPage = {
  ...
  "visualizerCaption": "A tree structure walkthrough for Binary Tree Traversal.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values Binary Tree Traversal needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that Binary Tree Traversal needs to inspect or change.",
      "activeLine": 1,
