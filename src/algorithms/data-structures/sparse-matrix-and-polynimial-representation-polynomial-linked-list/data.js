...
export const algorithmPage = {
  ...
  "meaning": "Sparse Matrix / Polynomial Polynomial Linked List shows how data is organized, changed, and inspected through a small browser demo with the original C/C++ reference available beside it.",
  ...
  "visualizerCaption": "A sparse polynomial walkthrough for Sparse Matrix / Polynomial Polynomial Linked List.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values Sparse Matrix / Polynomial Polynomial Linked List needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that Sparse Matrix / Polynomial Polynomial Linked List needs to inspect or change.",
      "activeLine": 1,
