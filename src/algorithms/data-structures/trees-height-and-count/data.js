...
export const algorithmPage = {
  ...
  "visualizerCaption": "A tree structure walkthrough for Binary Tree Height and Node Count.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values Binary Tree Height and Node Count needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that Binary Tree Height and Node Count needs to inspect or change.",
      "activeLine": 1,
