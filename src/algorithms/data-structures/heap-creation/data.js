...
export const algorithmPage = {
  ...
  "logicSummary": "Track the active state, promote or demote values to restore priority order, and inspect the updated view.",
  ...
  "visualizerCaption": "A heap operations walkthrough for Heap Creation.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values Heap Creation needs before any operation starts."
    },
    {
      "title": "Set the rule",
      "text": "Name the heap invariant that should remain true after the step."
    },
    {
      "title": "Apply one change",
      "text": "Run the next action: promote or demote values to restore priority order."
    },
    {
      "title": "Read the view",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that Heap Creation needs to inspect or change.",
      "activeLine": 1,
    ...
    },
    {
      ...
      "note": "Focus on the priority root before changing anything else.",
      "activeLine": 4,
    ...
    },
    {
      ...
      "note": "Perform one heap update and keep the invariant intact.",
      "activeLine": 7,
    ...
    },
    {
      ...
      "note": "Read the heap view after the update.",
      "activeLine": 10,
