...
export const algorithmPage = {
  ...
  "visualizerCaption": "An array adt walkthrough for Array ADT Creating Array Of Desired Size.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values Array ADT Creating Array Of Desired Size needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that Array ADT Creating Array Of Desired Size needs to inspect or change.",
      "activeLine": 1,
