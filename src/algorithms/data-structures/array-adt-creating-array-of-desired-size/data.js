...
export const algorithmPage = {
  "id": "ds-array-adt-creating-array-of-desired-size",
  "title": "Array ADT Creating Array Of Desired Size",
  "category": "Data Structures",
  "track": "Data Structures",
  "topicGroup": "Arrays / Array ADT",
  "sourceFolder": "05_Array_ADT",
  "sourceFile": "01_creating_array_of_desired_size.cpp",
  "sourceLanguage": "cpp",
  "route": "/algorithms/data-structures/array-adt-creating-array-of-desired-size",
  "phase": 1,
  "priority": "medium",
  "visualizerType": "array-adt",
  "icon": "view_week",
  "codePath": "./src/algorithms/data-structures/array-adt-creating-array-of-desired-size/code/solution.js",
  "codeFilename": "solution.js",
  "originalCodePath": "./src/algorithms/data-structures/array-adt-creating-array-of-desired-size/code/original.cpp",
  "originalCodeFilename": "01_creating_array_of_desired_size.cpp",
  "originalActiveLine": 4,
  "meaning": "Array ADT Creating Array Of Desired Size shows how data is organized, changed, and inspected through a small browser demo with the original C/C++ reference available beside it.",
  "problem": "Array ADT Creating Array Of Desired Size explains the array state model and how one focused change updates it.",
  "concept": "Array ADT Creating Array Of Desired Size is useful when contiguous storage, indexes, length, or capacity explain the operation. Use this when an array operation depends on slot position, bounds, or shifting values.",
  ...
  "realLifeExample": "Array ADT Creating Array Of Desired Size is useful when you need to understand the mechanics behind library-level data structures.",
  "whenToUse": "Use this page when learning Arrays / Array ADT behavior through state changes instead of memorized code.",
  "memoryTrick": "Array ADT Creating Array Of Desired Size: name the invariant, then trace the exact state change.",
  "visualizerCaption": "Array ADT Creating Array Of Desired Size is shown as indexed array state changes. The numbered steps follow the code path used to maintain the main invariant.",
  "logicSteps": [
    {
      "title": "Read request",
  ...
  "variables": [
    ...
    {
      "name": "array view",
      "purpose": "Shows the slots after Array ADT Creating Array Of Desired Size applies its operation."
    }
  ],
  "dryRun": [
    {
  ...
  "quiz": {
    "question": "What should you identify first when studying Array ADT Creating Array Of Desired Size?",
    "options": [
      {
        "key": "A",
  ...
  "algorithmSlug": "array-adt-creating-array-of-desired-size",
  "animation": {
    "type": "array-flow",
    "title": "Array ADT Creating Array Of Desired Size array state",
