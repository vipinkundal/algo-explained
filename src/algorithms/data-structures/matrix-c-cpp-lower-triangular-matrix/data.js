...
export const algorithmPage = {
  ...
  "meaning": "C++ Lower Triangular Matrix shows how data is organized, changed, and inspected through a small browser demo with the original C/C++ reference available beside it.",
  ...
  "visualizerCaption": "A matrix layout walkthrough for C++ Lower Triangular Matrix.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values C++ Lower Triangular Matrix needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that C++ Lower Triangular Matrix needs to inspect or change.",
      "activeLine": 1,
