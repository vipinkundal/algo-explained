...
export const algorithmPage = {
  ...
  "meaning": "C/C++ Array As Parameter shows how data is organized, changed, and inspected through a small browser demo with the original C/C++ reference available beside it.",
  ...
  "visualizerCaption": "A cpp memory model walkthrough for C/C++ Array As Parameter.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values C/C++ Array As Parameter needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that C/C++ Array As Parameter needs to inspect or change.",
      "activeLine": 1,
