  ...
  "dryRun": [
    {
      ...
      "activeLine": 2,
      "codeInsight": "Defines recursionTaylorSeriesUsingHornersRule and names the input n = 5; edits to those inputs change the visual state and output."
    },
    {
      "label": "Stack top",
      "title": "Inspect stack",
    ...
    },
    {
      ...
      "activeLine": 6,
      "codeInsight": "Returns value <= 1 ? 1 : value * factorial(value - 1), the final value maintained by Recursion Taylor Series Using Horners Rule's code path."
    }
  ],
  "complexity": {
