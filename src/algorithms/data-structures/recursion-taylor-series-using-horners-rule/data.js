...
export const algorithmPage = {
  ...
  "meaning": "Recursion Taylor Series Using Horners Rule shows how data is organized, changed, and inspected through a small browser demo with a C/C++ reference available beside it.",
  ...
  "concept": "Recursion Taylor Series Using Horners Rule is useful when stack behavior is the clearest model for the data changes. Use this when the problem is naturally described by last-in, first-out state.",
  ...
  "memoryTrick": "Recursion Taylor Series Using Horners Rule: name the invariant, then trace the exact state change.",
  "visualizerCaption": "Recursion Taylor Series Using Horners Rule is shown as stack state changes. The numbered steps follow the code path used to maintain the main invariant.",
  "logicSteps": [
    {
      "title": "Read stack",
  ...
  "dryRun": [
    ...
    },
    {
      ...
      "activeLine": 6,
      "codeInsight": "Returns value <= 1 ? 1 : value * factorial(value - 1), the value produced after Recursion Taylor Series Using Horners Rule's state changes are complete."
    }
  ],
  "complexity": {
  ...
  "animation": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "note": "The return value or printed state confirms the operation.",
        "ruleLabel": "Recursion Taylor Series Using Horners Rule invariant",
        "rule": "Returns value <= 1 ? 1 : value * factorial(value - 1), the value produced after Recursion Taylor Series Using Horners Rule's state changes are complete.",
        "activeCall": 3,
        "returningCalls": [
          0,
          1,
