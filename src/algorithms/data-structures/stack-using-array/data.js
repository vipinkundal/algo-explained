...
export const algorithmPage = {
  ...
  "visualizerCaption": "A stack operations walkthrough for Stack Using Array.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values Stack Using Array needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that Stack Using Array needs to inspect or change.",
      "activeLine": 1,
