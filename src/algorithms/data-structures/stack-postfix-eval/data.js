...
export const algorithmPage = {
  ...
  "meaning": "Stack Postfix Eval shows how data is organized, changed, and inspected through a small browser demo with the original C/C++ reference available beside it.",
  ...
  "visualizerCaption": "A stack operations walkthrough for Stack Postfix Eval.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values Stack Postfix Eval needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that Stack Postfix Eval needs to inspect or change.",
      "activeLine": 1,
