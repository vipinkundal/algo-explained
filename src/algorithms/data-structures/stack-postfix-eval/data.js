...
export const algorithmPage = {
  ...
  "dryRun": [
    ...
    },
    {
      ...
      "activeLine": 7,
      "codeInsight": "Returns { structure: \"stack\", invariant: \"last in, first out\", state: stack, popped: output }, the value produced after Stack Postfix Eval's state changes are complete."
    }
  ],
  "complexity": {
  ...
  "animation": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "note": "The return value or printed state confirms the operation.",
        "ruleLabel": "Stack Postfix Eval invariant",
        "rule": "Returns { structure: \"stack\", invariant: \"last in, first out\", state: stack, popped: output }, the value produced after Stack Postfix Eval's state changes are complete.",
        "activeItems": [
          3
        ],
        "topIndex": 3,
