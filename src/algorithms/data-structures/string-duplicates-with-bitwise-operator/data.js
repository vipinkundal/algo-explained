...
export const algorithmPage = {
  ...
  "meaning": "String Duplicates With Bitwise Operator shows how data is organized, changed, and inspected through a small browser demo with the original C/C++ reference available beside it.",
  ...
  "visualizerCaption": "A string scan walkthrough for String Duplicates With Bitwise Operator.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values String Duplicates With Bitwise Operator needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that String Duplicates With Bitwise Operator needs to inspect or change.",
      "activeLine": 1,
