...
export const algorithmPage = {
  ...
  "meaning": "String Duplicates With Bitwise Operator shows how data is organized, changed, and inspected through a small browser demo with a C/C++ reference available beside it.",
  "problem": "String Duplicates With Bitwise Operator explains the string state model and how one focused change updates it.",
  ...
  "realLifeExample": "String Duplicates With Bitwise Operator is useful when you need to understand the mechanics behind library-level data structures.",
  "whenToUse": "Use this page when learning Strings behavior through state changes instead of memorized code.",
  "memoryTrick": "String Duplicates With Bitwise Operator: name the invariant, then trace the exact state change.",
  "visualizerCaption": "String Duplicates With Bitwise Operator is shown as character-state updates. The numbered steps follow the code path used to maintain the main invariant.",
  "logicSteps": [
    {
      "title": "Read text",
  ...
  "variables": [
    ...
    {
      "name": "character bag",
      "purpose": "Tracks characters considered by String Duplicates With Bitwise Operator."
    },
    {
      "name": "text result",
  ...
  "dryRun": [
    ...
    },
    {
      ...
      "activeLine": 6,
      "codeInsight": "Executes this String Duplicates With Bitwise Operator line as part of the highlighted code path, linking the visual step to the implementation."
    },
    {
      "label": "Result",
      ...
      "activeLine": 5,
      "codeInsight": "Returns { structure: \"string\", input: text, reversed, length: text.length }, the value produced after String Duplicates With Bitwise Operator's state changes are complete."
    }
  ],
  "complexity": {
  ...
  "animation": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "note": "One character changes the active string state.",
        "ruleLabel": "String Duplicates With Bitwise Operator invariant",
        "rule": "Executes this String Duplicates With Bitwise Operator line as part of the highlighted code path, linking the visual step to the implementation.",
        "activeRange": [
          2,
          4
        ],
      ...
      },
      {
        ...
        "note": "Matches or best values are returned after the scan.",
        "ruleLabel": "String Duplicates With Bitwise Operator invariant",
        "rule": "Returns { structure: \"string\", input: text, reversed, length: text.length }, the value produced after String Duplicates With Bitwise Operator's state changes are complete.",
        "activeRange": [
          3,
          5
        ],
