...
export const algorithmPage = {
  ...
  "visualizerCaption": "A linked list walkthrough for Display Linked List.",
  "logicSteps": [
    {
      "title": "Map the state",
      "text": "Identify the values Display Linked List needs before any operation starts."
    },
    {
      "title": "Set the rule",
  ...
  "dryRun": [
    {
      ...
      "note": "Start with the values that Display Linked List needs to inspect or change.",
      "activeLine": 1,
