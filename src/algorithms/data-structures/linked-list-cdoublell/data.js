...
export const algorithmPage = {
  ...
  "meaning": "Circular Doubly Linked List shows how data is organized, changed, and inspected through a small browser demo with a C/C++ reference available beside it.",
  "problem": "Circular Doubly Linked List explains the linked-list state model and how one focused change updates it.",
  "concept": "Circular Doubly Linked List is useful when linked list behavior is the clearest model for the data changes. Use this when the problem is naturally described by node-link structure.",
  ...
  "memoryTrick": "Circular Doubly Linked List: name the invariant, then trace the exact state change.",
  "visualizerCaption": "Circular Doubly Linked List is shown as linked list state changes. The numbered steps follow the code path used to maintain the main invariant.",
  "logicSteps": [
    {
  ...
  "dryRun": [
    ...
    },
    {
      ...
      "activeLine": 5,
      "codeInsight": "Returns { structure: \"linked list\", operation: \"insert at position 1\", values: nodes.map((node) => node.value) }, the value produced after Circular Doubly Linked List's state changes are complete."
    },
    {
      "label": "Result",
  ...
  "animation": {
    ...
    "title": "Circular Doubly Linked List pointer state",
    ...
    "steps": [
      {
        ...
        "title": "Read linked list action",
        "note": "The code receives the next value or command.",
        "ruleLabel": "Circular Doubly Linked List invariant",
      ...
      },
      {
        ...
        "note": "Only the necessary linked list fields are changed.",
        "ruleLabel": "Circular Doubly Linked List invariant",
        "rule": "Returns { structure: \"linked list\", operation: \"insert at position 1\", values: nodes.map((node) => node.value) }, the value produced after Circular Doubly Linked List's state changes are complete.",
        "activeNode": "n3",
        "previousNode": "n2",
        "nextNode": "tail"
      },
