...
export const algorithmPage = {
  "id": "ds-array-adt-sum-of-k",
  "title": "Array ADT Sum Of K",
  "category": "Data Structures",
  "track": "Data Structures",
  "topicGroup": "Arrays / Array ADT",
  "sourceFolder": "05_Array_ADT",
  "sourceFile": "11_Sum_of_k.cpp",
  "sourceLanguage": "cpp",
  "route": "/algorithms/data-structures/array-adt-sum-of-k",
  "phase": 1,
  "priority": "medium",
  "visualizerType": "array-adt",
  "icon": "view_week",
  "codePath": "./src/algorithms/data-structures/array-adt-sum-of-k/code/solution.js",
  "codeFilename": "solution.js",
  "originalCodePath": "./src/algorithms/data-structures/array-adt-sum-of-k/code/original.cpp",
  "originalCodeFilename": "11_Sum_of_k.cpp",
  "originalActiveLine": 3,
  "meaning": "Array ADT Sum Of K shows how data is organized, changed, and inspected through a small browser demo with a C/C++ reference available beside it.",
  ...
  "variables": [
    ...
    {
      "name": "array view",
      "purpose": "Shows the slots after Array ADT Sum Of K applies its operation."
    }
  ],
  "dryRun": [
    {
    ...
    },
    {
      ...
      "activeLine": 6,
      "codeInsight": "Executes this Array ADT Sum Of K line as part of the highlighted code path, linking the visual step to the implementation."
    },
    {
      "label": "Result",
      ...
      "activeLine": 5,
      "codeInsight": "Returns { structure: \"array\", values, length: values.length, max: Math.max(...values), sum }, the value produced after Array ADT Sum Of K's state changes are complete."
    }
  ],
  "complexity": {
  ...
  "quiz": {
    "question": "What should you identify first when studying Array ADT Sum Of K?",
    "options": [
      {
        "key": "A",
  ...
  "algorithmSlug": "array-adt-sum-of-k",
  "animation": {
    "type": "array-flow",
    "title": "Array ADT Sum Of K array state",
    ...
    "steps": [
      {
        ...
        "title": "Read array request",
        "note": "The code receives an array plus an index, value, or command.",
        "ruleLabel": "Array ADT Sum Of K invariant",
      ...
      },
      {
        ...
        "note": "The operation sets, shifts, scans, or resizes array slots.",
        "ruleLabel": "Array ADT Sum Of K invariant",
        "rule": "Executes this Array ADT Sum Of K line as part of the highlighted code path, linking the visual step to the implementation.",
        "activeIndices": [
          2
        ],
        "sortedIndices": [],
      ...
      },
      {
        ...
        "note": "The visible value or updated array confirms the operation.",
        "ruleLabel": "Array ADT Sum Of K invariant",
        "rule": "Returns { structure: \"array\", values, length: values.length, max: Math.max(...values), sum }, the value produced after Array ADT Sum Of K's state changes are complete.",
        "activeIndices": [
          3,
          4
        ],
