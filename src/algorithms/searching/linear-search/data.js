...
export const algorithmPage = {
  ...
  "meaning": "Linear Search is a Searching technique taught with a array scan dry run.",
  "problem": "It helps you recognize and solve the Linear Search pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Linear Search: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Linear Search when a problem statement matches the Searching pattern and the planned visualization is array scan.",
  "memoryTrick": "Linear Search: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact array scan walkthrough for Linear Search.",
  "logicSteps": [
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Linear Search receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Linear Search?",
    "options": [
      {
        "key": "A",
