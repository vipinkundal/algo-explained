...
export const algorithmPage = {
  ...
  "dryRun": [
    ...
    },
    {
      ...
      "activeLine": 10,
      "codeInsight": "Checks array[mid] <= target; only the branch that preserves Upper Bound's invariant is allowed to change state."
    },
    {
      "label": "Return",
      ...
      "activeLine": 13,
      "codeInsight": "Returns low, the value produced after Upper Bound's state changes are complete."
    }
  ],
  "complexity": {
    "time": "O(log n).",
  ...
  "animation": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "note": "The midpoint decides which half is removed.",
        "ruleLabel": "Upper Bound invariant",
        "rule": "Checks array[mid] <= target; only the branch that preserves Upper Bound's invariant is allowed to change state.",
        "activeIndices": [
          2
        ],
        "sortedIndices": [],
      ...
      },
      {
        ...
        "note": "The loop ends with a match or the collapsed boundary.",
        "ruleLabel": "Upper Bound invariant",
        "rule": "Returns low, the value produced after Upper Bound's state changes are complete.",
        "activeIndices": [
          3,
          3
        ],
