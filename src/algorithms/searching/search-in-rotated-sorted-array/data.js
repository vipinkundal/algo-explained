...
export const algorithmPage = {
  ...
  "meaning": "Search in Rotated Sorted Array is a Searching technique taught with a rotated array dry run.",
  "problem": "It helps you recognize and solve the Search in Rotated Sorted Array pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Search in Rotated Sorted Array: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Search in Rotated Sorted Array when a problem statement matches the Searching pattern and the planned visualization is rotated array.",
  "memoryTrick": "Search in Rotated Sorted Array: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact rotated array walkthrough for Search in Rotated Sorted Array.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the rotated array idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Search in Rotated Sorted Array receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core rotated array transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Search in Rotated Sorted Array?",
    "options": [
      {
        "key": "A",
