...
export const algorithmPage = {
  ...
  "meaning": "LRU Cache is a Queue technique taught with a hashmap linkedlist dry run.",
  "problem": "It helps you recognize and solve the LRU Cache pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for LRU Cache: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use LRU Cache when a problem statement matches the Queue pattern and the planned visualization is hashmap linkedlist.",
  "memoryTrick": "LRU Cache: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact hashmap linkedlist walkthrough for LRU Cache.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the hashmap linkedlist idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what LRU Cache receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core hashmap linkedlist transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying LRU Cache?",
    "options": [
      {
        "key": "A",
