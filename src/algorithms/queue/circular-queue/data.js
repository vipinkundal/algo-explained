...
export const algorithmPage = {
  ...
  "meaning": "Circular Queue is a Queue technique taught with a circular buffer dry run.",
  "problem": "It helps you recognize and solve the Circular Queue pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Circular Queue: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Circular Queue when a problem statement matches the Queue pattern and the planned visualization is circular buffer.",
  "memoryTrick": "Circular Queue: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact circular buffer walkthrough for Circular Queue.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the circular buffer idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Circular Queue receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core circular buffer transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Circular Queue?",
    "options": [
      {
        "key": "A",
