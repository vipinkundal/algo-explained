...
export const algorithmPage = {
  ...
  "meaning": "Deque is a Queue technique taught with a double ended queue dry run.",
  "problem": "It helps you recognize and solve the Deque pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Deque: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Deque when a problem statement matches the Queue pattern and the planned visualization is double ended queue.",
  "memoryTrick": "Deque: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact double ended queue walkthrough for Deque.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the double ended queue idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Deque receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core double ended queue transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Deque?",
    "options": [
      {
        "key": "A",
