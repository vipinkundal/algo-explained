...
export const algorithmPage = {
  ...
  "variables": [
    {
      "name": "root",
      "purpose": "The concrete data Inorder Traversal receives before any state changes begin."
    },
    {
      "name": "current node and traversal state",
      "purpose": "The working information Inorder Traversal updates while it runs."
    },
    {
      "name": "tree result",
      "purpose": "The final value Inorder Traversal returns after the stop condition is met."
    },
    {
      "name": "node exists",
      "purpose": "The rule that decides whether Inorder Traversal continues, branches, or stops."
    }
  ],
  "dryRun": [
    {
