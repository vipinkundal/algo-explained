...
export const algorithmPage = {
  ...
  "meaning": "Inorder Traversal is a Trees technique taught with a tree traversal dry run.",
  "problem": "It helps you recognize and solve the Inorder Traversal pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Inorder Traversal: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Inorder Traversal when a problem statement matches the Trees pattern and the planned visualization is tree traversal.",
  "memoryTrick": "Inorder Traversal: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact tree traversal walkthrough for Inorder Traversal.",
  "logicSteps": [
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Inorder Traversal receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Inorder Traversal?",
    "options": [
      {
        "key": "A",
