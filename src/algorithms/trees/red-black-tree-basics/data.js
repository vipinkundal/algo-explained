...
export const algorithmPage = {
  ...
  "variables": [
    {
      "name": "root",
      "purpose": "The concrete data Red-Black Tree Basics receives before any state changes begin."
    },
    {
      "name": "current node and traversal state",
      "purpose": "The working information Red-Black Tree Basics updates while it runs."
    },
    {
      "name": "tree result",
      "purpose": "The final value Red-Black Tree Basics returns after the stop condition is met."
    },
    {
      "name": "node exists",
      "purpose": "The rule that decides whether Red-Black Tree Basics continues, branches, or stops."
    }
  ],
  "dryRun": [
    {
