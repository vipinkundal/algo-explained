...
export const algorithmPage = {
  ...
  "variables": [
    {
      "name": "root",
      "purpose": "The concrete data Level Order Traversal receives before any state changes begin."
    },
    {
      "name": "current node and traversal state",
      "purpose": "The working information Level Order Traversal updates while it runs."
    },
    {
      "name": "tree result",
      "purpose": "The final value Level Order Traversal returns after the stop condition is met."
    },
    {
      "name": "node exists",
      "purpose": "The rule that decides whether Level Order Traversal continues, branches, or stops."
    }
  ],
  "dryRun": [
    {
