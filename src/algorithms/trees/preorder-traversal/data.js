...
export const algorithmPage = {
  ...
  "dryRun": [
    ...
    },
    {
      ...
      "activeLine": 14,
      "codeInsight": "Returns result, the final value maintained by Preorder Traversal's code path."
    }
  ],
  "complexity": {
  ...
  "animation": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "note": "The final traversal, path, measurement, or tree state is returned.",
        "ruleLabel": "Preorder Traversal invariant",
        "rule": "Returns result, the final value maintained by Preorder Traversal's code path.",
        "activeNode": "2",
        "targetNode": "6",
        "replacementNode": "6",
        "mutedNodes": []
