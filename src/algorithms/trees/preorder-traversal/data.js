...
export const algorithmPage = {
  ...
  "variables": [
    ...
    {
      "name": "tree result",
      "purpose": "The value produced by preorderTraversal after the maintained state reaches the stop rule."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "activeLine": 5,
      "codeInsight": "Defines preorderTraversal and names the input root; edits to those inputs change the visual state and output."
    },
    {
      "label": "Node state",
      ...
      "activeLine": 8,
      "codeInsight": "Checks !node; only the branch that preserves Preorder Traversal's invariant is allowed to change state."
    },
    {
      "label": "Child step",
    ...
    },
    {
      ...
      "activeLine": 14,
      "codeInsight": "Returns result, the value produced after Preorder Traversal's state changes are complete."
    }
  ],
  "complexity": {
  ...
  "animation": {
    "type": "tree-operation",
    "title": "Preorder Traversal tree state",
    "nodes": [
      {
        "id": "8",
        "label": "8",
    ...
    "steps": [
      {
        ...
        "title": "Check current node",
        "note": "The code starts by handling missing nodes or the current root.",
        "ruleLabel": "Preorder Traversal invariant",
        "rule": "Defines preorderTraversal and names the input root; edits to those inputs change the visual state and output.",
        "activeNode": "8",
        "targetNode": "4",
        "replacementNode": "",
        "mutedNodes": [
      ...
      },
      {
        ...
        "note": "The current node controls the next step.",
        "ruleLabel": "Preorder Traversal invariant",
        "rule": "Checks !node; only the branch that preserves Preorder Traversal's invariant is allowed to change state.",
        "activeNode": "4",
        "targetNode": "12",
        "replacementNode": "",
        "mutedNodes": [
      ...
      },
      {
        ...
        "note": "The final traversal, path, measurement, or tree state is returned.",
        "ruleLabel": "Preorder Traversal invariant",
        "rule": "Returns result, the value produced after Preorder Traversal's state changes are complete.",
        "activeNode": "2",
        "targetNode": "6",
        "replacementNode": "6",
        "mutedNodes": []
