...
export const algorithmPage = {
  ...
  "variables": [
    {
      "name": "root",
      "purpose": "The concrete data Lowest Common Ancestor receives before any state changes begin."
    },
    {
      "name": "current node and traversal state",
      "purpose": "The working information Lowest Common Ancestor updates while it runs."
    },
    {
      "name": "tree result",
      "purpose": "The final value Lowest Common Ancestor returns after the stop condition is met."
    },
    {
      "name": "node exists",
      "purpose": "The rule that decides whether Lowest Common Ancestor continues, branches, or stops."
    }
  ],
  "dryRun": [
    {
