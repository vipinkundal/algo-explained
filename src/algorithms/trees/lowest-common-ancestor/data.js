...
export const algorithmPage = {
  ...
  "meaning": "Lowest Common Ancestor is a Trees technique taught with a tree paths dry run.",
  "problem": "It helps you recognize and solve the Lowest Common Ancestor pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Lowest Common Ancestor: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Lowest Common Ancestor when a problem statement matches the Trees pattern and the planned visualization is tree paths.",
  "memoryTrick": "Lowest Common Ancestor: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact tree paths walkthrough for Lowest Common Ancestor.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the tree paths idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Lowest Common Ancestor receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core tree paths transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Lowest Common Ancestor?",
    "options": [
      {
        "key": "A",
