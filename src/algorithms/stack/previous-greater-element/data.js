...
export const algorithmPage = {
  ...
  "meaning": "Previous Greater Element is a Stack technique taught with a monotonic stack dry run.",
  "problem": "It helps you recognize and solve the Previous Greater Element pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Previous Greater Element: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Previous Greater Element when a problem statement matches the Stack pattern and the planned visualization is monotonic stack.",
  "memoryTrick": "Previous Greater Element: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact monotonic stack walkthrough for Previous Greater Element.",
  "logicSteps": [
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Previous Greater Element receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Previous Greater Element?",
    "options": [
      {
        "key": "A",
