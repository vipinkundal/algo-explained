...
export const algorithmPage = {
  ...
  "meaning": "Stack Basics is a Stack technique taught with a stack push pop dry run.",
  "problem": "It helps you recognize and solve the Stack Basics pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Stack Basics: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Stack Basics when a problem statement matches the Stack pattern and the planned visualization is stack push pop.",
  "memoryTrick": "Stack Basics: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact stack push pop walkthrough for Stack Basics.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the stack push pop idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Stack Basics receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core stack push pop transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Stack Basics?",
    "options": [
      {
        "key": "A",
