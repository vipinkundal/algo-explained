...
export const algorithmPage = {
  ...
  "meaning": "Min Stack is a Stack technique taught with a dual stack dry run.",
  "problem": "It helps you recognize and solve the Min Stack pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Min Stack: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Min Stack when a problem statement matches the Stack pattern and the planned visualization is dual stack.",
  "memoryTrick": "Min Stack: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact dual stack walkthrough for Min Stack.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the dual stack idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Min Stack receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core dual stack transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Min Stack?",
    "options": [
      {
        "key": "A",
