...
export const algorithmPage = {
  ...
  "meaning": "Valid Parentheses is a Stack technique taught with a stack match dry run.",
  "problem": "It helps you recognize and solve the Valid Parentheses pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Valid Parentheses: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Valid Parentheses when a problem statement matches the Stack pattern and the planned visualization is stack match.",
  "memoryTrick": "Valid Parentheses: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact stack match walkthrough for Valid Parentheses.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the stack match idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Valid Parentheses receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core stack match transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Valid Parentheses?",
    "options": [
      {
        "key": "A",
