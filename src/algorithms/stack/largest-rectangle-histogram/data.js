...
export const algorithmPage = {
  ...
  "meaning": "Largest Rectangle in Histogram is a Stack technique taught with a monotonic stack bars dry run.",
  "problem": "It helps you recognize and solve the Largest Rectangle in Histogram pattern without mixing it with other algorithms.",
  "realLifeExample": "Think of this page as the isolated practice bench for Largest Rectangle in Histogram: inputs come in, key state changes are tracked, and the result is produced step by step.",
  "whenToUse": "Use Largest Rectangle in Histogram when a problem statement matches the Stack pattern and the planned visualization is monotonic stack bars.",
  "memoryTrick": "Largest Rectangle in Histogram: name the state, update it once per step, and check the stop condition before returning.",
  "visualizerCaption": "A compact monotonic stack bars walkthrough for Largest Rectangle in Histogram.",
  "logicSteps": [
    {
    ...
    },
    {
      ...
      "text": "Move through the input using the monotonic stack bars idea and update only the relevant state."
    },
    {
  ...
  "dryRun": [
    {
      ...
      "note": "Start by identifying what Largest Rectangle in Histogram receives and what output is expected.",
      "activeLine": 1
    },
    {
      "label": "State",
    ...
    },
    {
      ...
      "note": "Apply the core monotonic stack bars transition and keep unrelated state untouched.",
      "activeLine": 6
    },
    {
      "label": "Answer",
  ...
  "quiz": {
    "question": "What is the safest first step when applying Largest Rectangle in Histogram?",
    "options": [
      {
        "key": "A",
